package com.newland.property.job.task.parkingSpace;
...
//        visitDto.setState(visitDto.STATE_C); //访客记录审核通过
        ...
        for (VisitDto visit : visitDtos) {
            ...
            if (StringUtil.isEmpty(parkingSpaceDtos.get(0).getState()) || !"H".equals(parkingSpaceDtos.get(0).getState())) { //出售 S，出租 H ，空闲 F
                continue;
            }
            //修改车位状态
