package com.newland.property.job.adapt.roomRenovation;
...
import com.newland.property.intf.user.IRoomRenovationsInnerServiceSMO;
...
public class MachineRoomRenovationDetail extends DatabusAdaptImpl {
    ...
    public void execute(Business business, List<Business> businesses) {
        ...
        String stateMark = "";
        if ("5000".equals(state)) {
            stateMark = "通过";
        } else if ("6000".equals(state)) {
            stateMark = "不通过";
        }
        //获得验收备注
