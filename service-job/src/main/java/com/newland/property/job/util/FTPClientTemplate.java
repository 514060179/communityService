...
import com.newland.property.job.smo.impl.HcFtpFileSMOImpl;
...
//        UploadStatus status = UploadStatus.Create_Directory_Success;   
        ...
        FTPClient ftpClient=getFTPClient();
        if(!"/".equalsIgnoreCase(directory)&&!ftpClient.changeWorkingDirectory(new String(directory.getBytes("GBK"),"iso-8859-1"))){
