...
import com.newland.property.dto.wechat.WechatSubscribeDto;
import com.newland.property.dto.wechat.Content;
import com.newland.property.dto.wechat.Data;
import com.newland.property.dto.wechat.Miniprogram;
...
import com.newland.property.intf.user.IWechatSubscribeV1InnerServiceSMO;
...
import com.newland.property.po.wechat.WechatSubscribePo;
...
public class WeChatPushMessageTemplate extends TaskSystemQuartz {
    ...
    private PropertyThreadPoolFactory<PublicWeChatPushMessageTemplate> publicWeChatPushMessageTemplatePropertyThreadPoolFactory = null;

    @Override
    protected void process(TaskDto taskDto) {
        logger.debug("开始执行微信模板信息推送" + taskDto.toString());
        //创建连接池
        publicWeChatPushMessageTemplatePropertyThreadPoolFactory = PropertyThreadPoolFactory.getInstance().createThreadPool(DEFAULT_THREAD_NUM);
        // 获取小区
        ...
        publicWeChatPushMessageTemplatePropertyThreadPoolFactory.stop();
    }
    ...
    @NewlandPropertySynchronized(value = "communityId")
...
//        doSend(ownerAppUserDtos, noticeDto, templateId, accessToken, weChatDto);
    ...
    private void sendAllOwner(NoticeDto noticeDto, String templateId, String accessToken, SmallWeChatDto weChatDto) {
        ...
        for (WechatSubscribeDto wechatSubscribeDto1 : wechatSubscribeDtos) {
            ...
            try {
                ...
                publicWeChatPushMessageTemplatePropertyThreadPoolFactory.submit(pushWechatTemplateMessageThread);
    ...
    private void doSend(List<OwnerAppUserDto> ownerAppUserDtos, NoticeDto noticeDto, String templateId, String accessToken, SmallWeChatDto weChatDto) {
        ...
        for (OwnerAppUserDto appUserDto : ownerAppUserDtos) {
            ...
            if (!StringUtil.isEmpty(noticeDto.getObjType()) && "004".equals(noticeDto.getObjType())) { //房屋
