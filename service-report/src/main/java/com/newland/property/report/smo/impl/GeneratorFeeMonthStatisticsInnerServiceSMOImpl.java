...
import com.newland.property.intf.report.IGeneratorFeeMonthStatisticsInnerServiceSMO;
...
import com.newland.property.report.dao.IReportFeeMonthStatisticsServiceDao;
import com.newland.property.report.dao.IReportFeeServiceDao;
import com.newland.property.utils.util.*;
import com.newland.property.utils.constant.FeeConfigConstant;
...
//            reportFeeMonthStatisticsPo.setReceivedAmount("0");
            ...
            if (!StringUtil.isEmpty(statistic.getObjType()) && "3333".equals(statistic.getObjType())) { //房屋
