...
public class QueryServiceSMOImplTest extends TestCase {
    ...
    public void testJava() throws CannotCompileException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, NotFoundException, IOException, ClassNotFoundException {
        ...
        classPool.importPackage("com.newland.property.entity.service.DataQuery");
        classPool.importPackage("com.newland.property.dto.system.ServiceSql");
        CtClass ctClass = classPool.makeClass("com.newland.property.service.smo.WuxwTest3");
        ...
        CtClass ctClass2 = classPool.get("com.newland.property.service.smo.WuxwTest3");
        CtMethod helloM3 = CtNewMethod.make(javaCode3, ctClass2);
        ctClass2.addMethod(helloM3);
        //ctClass.detach();

       // CtClass ctClass3 = classPool.get("com.newland.property.service.smo.WuxwTest1");

        /*HotSwapper swap = new HotSwapper(8000);
        swap.reload("com.newland.property.service.smo.WuxwTest3",ctClass2.toBytecode());
        Class ctClass1 = Class.forName("com.newland.property.service.smo.WuxwTest3");
    ...
    public void testExistsJavaClass() throws Exception{
        ClassPool classPool = ClassPool.getDefault();
        CtClass ctClass = classPool.get("com.newland.property.core.javassist.NewlandPropertyCoreTemplateJavassist");
