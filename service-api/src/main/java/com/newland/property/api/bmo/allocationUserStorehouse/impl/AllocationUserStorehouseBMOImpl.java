package com.newland.property.api.bmo.allocationUserStorehouse.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.newland.property.api.bmo.allocationUserStorehouse.IAllocationUserStorehouseBMO;
import com.newland.property.api.listener.AbstractServiceApiPlusListener;
...
import com.newland.property.po.purchase.AllocationUserStorehousePo;
...
public class AllocationUserStorehouseBMOImpl extends AbstractServiceApiPlusListener implements IAllocationUserStorehouseBMO {
    ...
    public void addAllocationUserStorehouse(JSONObject paramInJson, DataFlowContext dataFlowContext) {
        ...
        if (json.size() > 0) {
            ...
            if (!StringUtil.isEmpty(flag) && "1".equals(flag)) { //损耗
