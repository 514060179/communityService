 ...
 */
package com.newland.property.api.smo.payment.adapt.wechatPay;
...
public class WechatPayAdapt implements IPayAdapt {
    ...
    private Map<String, String> newlandUnifieldOrder(RestTemplate outRestTemplate, String feeName, String orderNum,
        ...
        return newlandUnifieldOrder(outRestTemplate, feeName, orderNum, tradeType, payAmount, openid, smallWeChatDto,
                wechatAuthProperties.getWxNotifyUrl());
    }
