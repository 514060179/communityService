package com.newland.property.api.rest;

import com.alibaba.fastjson.JSONObject;
import com.newland.property.api.smo.IApiServiceSMO;
...
@NewlandPropertyRequestMappingsDoc(
        mappingsDocs = {
                @NewlandPropertyRequestMappingDoc(name="用户中心",resource = "userDoc",url="http://user-service",seq = 1),
                @NewlandPropertyRequestMappingDoc(name="资产中心",resource = "communityDoc",url="http://community-service",seq = 2),
                @NewlandPropertyRequestMappingDoc(name="商户中心",resource = "storeDoc",url="http://store-service",seq = 3),
                @NewlandPropertyRequestMappingDoc(name="账户中心",resource = "acctDoc",url="http://acct-service",seq = 4),
                @NewlandPropertyRequestMappingDoc(name="通用中心",resource = "commonDoc",url="http://common-service",seq = 5),
                @NewlandPropertyRequestMappingDoc(name="费用中心",resource = "feeDoc",url="http://fee-service",seq = 6),
                @NewlandPropertyRequestMappingDoc(name="报表中心",resource = "reportDoc",url="http://report-service",seq = 7),
        }
)
