package com.newland.property.api.aop;
...
public class PageProcessAspect {
    ...
    public void deBefore(JoinPoint joinPoint) throws Throwable {
        ...
        //调用链
        //newlandTraceFactory.createTrace(componentCode + "/" + componentMethod, headers);
    }
    ...
    public void after(JoinPoint jp) throws IOException {
        ...
        HttpServletRequest request = attributes.getRequest();
        //记录调用链
        //newlandTraceFactory.putAnnotations(TraceAnnotationsDto.VALUE_CLIENT_RECEIVE);
