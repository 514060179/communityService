 ...
 */
package com.newland.property.api.smo.payment.adapt.chinaums;
...
public class ChinaUmsPayAdapt implements IPayAdapt {
    ...
    public Map<String, String> newlandPropertyPayment(RestTemplate outRestTemplate,
        ...
        if (StringUtil.isEmpty(notifyUrl)) {
            resMap = this.newlandUnifieldOrder(outRestTemplate, feeName, orderNum, tradeType, payAmount, openId,
                    smallWeChatDto);
        } else {
            resMap = this.newlandUnifieldOrder(outRestTemplate, feeName, orderNum, tradeType, payAmount, openId,
                    smallWeChatDto, notifyUrl);
        }
