...
import com.newland.property.api.smo.IGetCommunityStoreInfoSMO;
import com.newland.property.api.smo.IPrivilegeServiceSMO;
...
public class PrivilegeServiceSMOImpl extends DefaultAbstractComponentSMO implements IPrivilegeServiceSMO {
    ...
    public ResponseEntity<String> listNoAddPrivilege(IPageData pd) {
        ...
        Object lang = pd.getHeaders().get(CommonConstant.PROPERTY_LANG);
