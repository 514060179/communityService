 ...
 */
public class NewlandPropertyCmdDocDiscoveryRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, BeanClassLoaderAware {

    private ResourceLoader resourceLoader;

    private ClassLoader classLoader;

    public NewlandPropertyCmdDocDiscoveryRegistrar() {
    ...
    public void registerListener(AnnotationMetadata metadata,
        ...
        Map<String, Object> attrs = metadata
                .getAnnotationAttributes(NewlandPropertyCmdDocDiscovery.class.getName());
                ...
                if (candidateComponent instanceof AnnotatedBeanDefinition) {
                    ...
                    Map<String, Object> attributes = annotationMetadata
                            .getAnnotationAttributes(
                                    NewlandPropertyCmdDoc.class.getCanonicalName());
                    ...
                    if (beanDefinition.getMetadata().isInterface()
                        ...
                        try {
                            Class<?> target = ClassUtils.forName(
                                    ...
                                    NewlandPropertyCmdDocDiscoveryRegistrar.this.classLoader);
    ...
    protected Set<String> getBasePackages(AnnotationMetadata importingClassMetadata) {
        Map<String, Object> attributes = importingClassMetadata
                .getAnnotationAttributes(NewlandPropertyCmdDocDiscovery.class.getCanonicalName());
