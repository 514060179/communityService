 ...
 */
public class NewlandPropertyApiDocDiscoveryRegistrar implements ImportBeanDefinitionRegistrar,ResourceLoaderAware, BeanClassLoaderAware {

    private ResourceLoader resourceLoader;

    private ClassLoader classLoader;

    public NewlandPropertyApiDocDiscoveryRegistrar(){
    ...
    public void registerListener(AnnotationMetadata metadata,
        ...
        Map<String, Object> attrs = metadata
                .getAnnotationAttributes(NewlandPropertyApiDocDiscovery.class.getName());
                ...
                if (candidateComponent instanceof AnnotatedBeanDefinition) {
                    ...
                    Map<String, Object> attributes = annotationMetadata
                            .getAnnotationAttributes(
                                    NewlandPropertyApiDoc.class.getCanonicalName());
                    ...
                    attributes = annotationMetadata
                            .getAnnotationAttributes(
                    NewlandPropertyRequestMappingsDoc.class.getCanonicalName());
                    ...
                    if (beanDefinition.getMetadata().isInterface()
                        ...
                        try {
                            Class<?> target = ClassUtils.forName(
                                    ...
                                    NewlandPropertyApiDocDiscoveryRegistrar.this.classLoader);
    ...
    protected Set<String> getBasePackages(AnnotationMetadata importingClassMetadata) {
        Map<String, Object> attributes = importingClassMetadata
                .getAnnotationAttributes(NewlandPropertyApiDocDiscovery.class.getCanonicalName());
