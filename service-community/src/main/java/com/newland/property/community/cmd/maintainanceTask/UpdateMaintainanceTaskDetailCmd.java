 ...
 */
@NewlandPropertyCmd(serviceCode = "maintainanceTask.updateMaintainanceTaskDetail")
...
//        maintainanceTaskInnerServiceSMOImpl.updateMaintainanceTask(maintainanceTask);
    ...
    public void updateMaintainanceTask(JSONObject paramInJson) {
        ...
        if (!StringUtil.isEmpty(paramInJson.getString("taskType")) && "2000".equals(paramInJson.getString("taskType"))) {
