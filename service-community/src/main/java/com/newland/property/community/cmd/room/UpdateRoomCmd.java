...
@NewlandPropertyCmdDoc(title = "修改房屋",
...
@NewlandPropertyCmd(serviceCode = "room.updateRoom")
public class UpdateRoomCmd extends Cmd {
    ...
    public void validate(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        if (!StringUtil.isEmpty(state) && "2006".equals(state)) { //已出租
            //获取起租时间
            Date startTime = null;
            Date endTime = null;
    ...
    public void updateShellRoom(JSONObject paramInJson, ICmdDataFlowContext cmdDataFlowContext) {
        ...
        if (paramInJson.containsKey("apartment1") && "10".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("1");
        } else if (paramInJson.containsKey("apartment1") && "20".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("2");
        } else if (paramInJson.containsKey("apartment1") && "30".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("3");
        } else if (paramInJson.containsKey("apartment1") && "40".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("4");
        } else if (paramInJson.containsKey("apartment1") && "50".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("5");
        } else if (paramInJson.containsKey("apartment1") && "60".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("6");
        } else if (paramInJson.containsKey("apartment1") && "70".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("7");
        } else if (paramInJson.containsKey("apartment1") && "80".equals(paramInJson.getString("apartment1"))) {
            roomPo.setSection("8");
        }
