 ...
 */
package com.newland.property.community.cmd.communityVenue;
...
import com.newland.property.intf.community.ICommunityVenueV1InnerServiceSMO;
...
import com.newland.property.dto.community.CommunityVenueDto;
...
@NewlandPropertyCmdDoc(title = "查询场馆",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "venueId", type = "String", remark = "场馆编号"),
        }
)
 ...
 */
@NewlandPropertyCmd(serviceCode = "communityVenue.listCommunityVenue")
