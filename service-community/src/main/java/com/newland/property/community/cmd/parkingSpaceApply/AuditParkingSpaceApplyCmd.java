 ...
 */
@NewlandPropertyCmd(serviceCode = "parkingSpaceApply.auditParkingSpaceApply")
public class AuditParkingSpaceApplyCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        // todo 车位申请审核通过发推送-jpush
        // appPage: /pages/applyparking/parkingInfo

        JPushMessageDto messageDto = new JPushMessageDto();
        messageDto.setCommunityId(ownerCarDtos.get(0).getCommunityId());
        messageDto.setUserId(ownerCarDtos.get(0).getUserId());
        messageDto.setPageUrl("/pages/applyparking/parkingInfo");
        messageDto.setTitle("车位申请");
        messageDto.setContent("您的车位申请审核通过");
