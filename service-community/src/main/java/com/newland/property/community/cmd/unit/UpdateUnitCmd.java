...
@NewlandPropertyCmdDoc(title = "修改单元",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "unitNum", length = 30, remark = "单元"),
        @NewlandPropertyParamDoc(name = "layerCount", length = 30, remark = "楼层"),
        @NewlandPropertyParamDoc(name = "lift", length = 30, remark = "1010 有电梯 2020 无电梯"),
        @NewlandPropertyParamDoc(name = "unitArea", length = 30, remark = "面积"),
})
...
@NewlandPropertyCmd(serviceCode = "unit.updateUnit")
