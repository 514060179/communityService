...
@NewlandPropertyCmd(serviceCode = "room.addRoomBinding")
public class AddRoomBindingCmd extends Cmd {
    ...
    public void validate(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) {
        ...
        for (int roomIndex = 0; roomIndex < infos.size(); roomIndex++) {
            ...
            if (_info.containsKey("addRoomView") && "addRoomView".equals(_info.getString("flowComponent"))) {
                addRoomView = _info;
                break;
            }
        }
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        if (!hasKey(addRoomView, "roomId")) {
            ...
            if (addRoomView.containsKey("apartment1") && "10".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("1");
            } else if (addRoomView.containsKey("apartment1") && "20".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("2");
            } else if (addRoomView.containsKey("apartment1") && "30".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("3");
            } else if (addRoomView.containsKey("apartment1") && "40".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("4");
            } else if (addRoomView.containsKey("apartment1") && "50".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("5");
            } else if (addRoomView.containsKey("apartment1") && "60".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("6");
            } else if (addRoomView.containsKey("apartment1") && "70".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("7");
            } else if (addRoomView.containsKey("apartment1") && "80".equals(addRoomView.getString("apartment1"))) {
                roomPo.setSection("8");
            }
