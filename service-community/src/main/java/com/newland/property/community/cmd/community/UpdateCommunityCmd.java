...
import com.newland.property.community.bmo.community.ICommunityBMO;
...
import com.newland.property.po.privilege.RoleCommunityPo;
...
@NewlandPropertyCmdDoc(title = "修改小区",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "address", length = 30, remark = "小区地址"),
        @NewlandPropertyParamDoc(name = "cityCode", length = 12, remark = "地区编码"),
        @NewlandPropertyParamDoc(name = "feePrice", type = "int", length = 11, remark = "小区收费价格"),
        @NewlandPropertyParamDoc(name = "mapX", length = 12, remark = "经度"),
        @NewlandPropertyParamDoc(name = "mapY", length = 12, remark = "纬度"),
        ...
        @NewlandPropertyParamDoc(name = "payFeeMonth", type = "int", length = 11, remark = "小区收费周期"),
        @NewlandPropertyParamDoc(name = "tel", length = 11, remark = "小区客服电话"),
})
 ...
 */
@NewlandPropertyCmd(serviceCode = "community.updateCommunity")
