 ...
 */
@NewlandPropertyCmd(serviceCode = "communityLocation.listCommunityLocations")
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext context, JSONObject reqJson) throws CmdException {
        ...
        if (count > 0) {
            ...
            for (CommunityLocationDto communityLocation : communityLocations) {
                if (!StringUtil.isEmpty(communityLocation.getLocationType()) && "2000".equals(communityLocation.getLocationType())
                        && !StringUtil.isEmpty(communityLocation.getLocationObjId()) && !"-1".equals(communityLocation.getLocationObjId())) { //单元
                ...
                } else if (!StringUtil.isEmpty(communityLocation.getLocationType()) && "6000".equals(communityLocation.getLocationType())
                        && !StringUtil.isEmpty(communityLocation.getLocationObjId()) && !"-1".equals(communityLocation.getLocationObjId())) { //楼栋
                    communityLocation.setFloorId(communityLocation.getLocationObjId());
                } else if (!StringUtil.isEmpty(communityLocation.getLocationType()) && "7000".equals(communityLocation.getLocationType())
                        && !StringUtil.isEmpty(communityLocation.getLocationObjId()) && !"-1".equals(communityLocation.getLocationObjId())) { //停车场
                    communityLocation.setPaId(communityLocation.getLocationObjId());
                } else if (!StringUtil.isEmpty(communityLocation.getLocationType()) && "4000".equals(communityLocation.getLocationType())
                        && !StringUtil.isEmpty(communityLocation.getLocationObjId()) && !"-1".equals(communityLocation.getLocationObjId())) { //岗亭
