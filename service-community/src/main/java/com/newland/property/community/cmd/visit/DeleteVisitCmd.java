...
@NewlandPropertyCmd(serviceCode = "visit.deleteVisit")
public class DeleteVisitCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext context, JSONObject reqJson) throws CmdException {
        ...
        if (!StringUtil.isEmpty(visitDtos.get(0).getCarNum()) && !StringUtil.isEmpty(visitDtos.get(0).getPsId()) && !"-1".equals(visitDtos.get(0).getPsId())) { //有车辆，且有车位
            ...
            if ("H".equals(parkingSpaceDtos.get(0).getState())) { //车位状态 出售 S，出租 H ，空闲 F
