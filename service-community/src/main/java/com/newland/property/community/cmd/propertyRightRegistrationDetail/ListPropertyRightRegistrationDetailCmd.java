 ...
 */
@NewlandPropertyCmd(serviceCode = "propertyRightRegistrationDetail.listPropertyRightRegistrationDetail")
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        if (count > 0) {
            ...
            for (PropertyRightRegistrationDetailDto propertyRightRegistrationDetail : propertyRightRegistrationDetails) {
                ...
                String repairUrl = "";
                String deedTaxUrl = "";
                if (!StringUtil.isEmpty(securities) && "001".equals(securities)) { //身份证
                    securitiesName = "身份证";
                    //查询房屋产权身份证图片
                ...
                } else if (!StringUtil.isEmpty(securities) && "002".equals(securities)) {
                    securitiesName = "购房合同";
                    //查询房屋产权购房合同图片
                    FileRelDto fileRelDto = new FileRelDto();
                    fileRelDto.setObjId(propertyRightRegistrationDetail.getPrrId());
                ...
                } else if (!StringUtil.isEmpty(securities) && "003".equals(securities)) {
                    securitiesName = "维修基金";
                    //查询房屋产权维修基金图片
                    FileRelDto fileRelDto = new FileRelDto();
                    fileRelDto.setObjId(propertyRightRegistrationDetail.getPrrId());
                ...
                } else if (!StringUtil.isEmpty(securities) && "004".equals(securities)) {
                    securitiesName = "契税";
                    //查询房屋产权契税图片
                    FileRelDto fileRelDto = new FileRelDto();
                    fileRelDto.setObjId(propertyRightRegistrationDetail.getPrrId());
