...
import com.newland.property.dto.activities.ActivitiesDto;
import com.newland.property.intf.community.IActivitiesInnerServiceSMO;
...
import com.newland.property.vo.api.activities.ApiActivitiesVo;
 ...
 */
@NewlandPropertyCmd(serviceCode = "activities.listActivitiess")
public class ListActivitiessCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext context, JSONObject reqJson) throws CmdException {
        ...
        if(reqJson.containsKey("communityId")) {
            count = activitiesInnerServiceSMOImpl.queryActivitiessCount(activitiesDto);
            if (count > 0) {
