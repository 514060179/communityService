...
import com.newland.property.intf.community.ICommunitySpaceConfirmOrderV1InnerServiceSMO;
import com.newland.property.doc.annotation.*;
import com.newland.property.utils.exception.CmdException;
import com.newland.property.utils.util.BeanConvertUtil;
import com.newland.property.vo.ResultVo;
import org.springframework.beans.factory.annotation.Autowired;
import com.newland.property.dto.community.CommunitySpaceConfirmOrderDto;
...
@NewlandPropertyCmdDoc(title = "查询预约核销订单",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "communityId", type = "String", remark = "小区ID"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "appointmentTime", type = "String", remark = "预约时间"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "createTime", type = "String", remark = "核销时间"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "hours", type = "String", remark = "核销小时"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "orderId", type = "String", remark = "核销订单ID"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "personName", type = "String", remark = "预约人"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "personTel", type = "String", remark = "预约电话"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "tel", type = "String", remark = "联系电话"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "spaceId", type = "String", remark = "场地ID"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "spaceName", type = "String", remark = "场地名称"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "timeId", type = "String", remark = "核销ID"),
        }
)
 ...
 */
@NewlandPropertyCmd(serviceCode = "communitySpace.listCommunitySpaceConfirmOrder")
