...
@NewlandPropertyCmd(serviceCode = "ownerRepair.appraiseRepair")
public class AppraiseRepairCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext context, JSONObject reqJson) throws CmdException, ParseException {
        ...
        if ("Z".equals(repairChannel)) { //如果是业主端报修，就查询是否有已评价状态的
            repairUserDto.setState(RepairUserDto.STATE_FINISH);
        } else if (!StringUtil.isEmpty(maintenanceType) && "1001".equals(maintenanceType)) { //如果不是业主端报修，且是有偿的，就查询已支付状态的
