package com.newland.property.community.cmd.notice;
...
import com.newland.property.vo.api.notice.ApiNoticeDataVo;
import com.newland.property.vo.api.notice.ApiNoticeVo;
...
@NewlandPropertyCmdDoc(title = "查询公告",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "row", type = "int",length = 30, remark = "行数"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "token",name = "abc", type = "String", remark = "临时票据"),
...
@NewlandPropertyCmd(serviceCode = "notice.listNotices")
