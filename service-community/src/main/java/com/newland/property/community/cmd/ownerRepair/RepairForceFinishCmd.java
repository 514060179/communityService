...
@NewlandPropertyCmd(serviceCode = "ownerRepair.repairForceFinish")
public class RepairForceFinishCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext context, JSONObject reqJson) throws CmdException, ParseException {
        ...
        if (json != null && json.size() > 0 && ("1001".equals(maintenanceType) || "1003".equals(maintenanceType))) { //有偿或需要用料
            ...
            //有偿服务生成费用
            if ("1001".equals(maintenanceType) && StringUtil.isEmpty(reqJson.getString("sign"))) {
                //查询默认费用项
        ...
        if("1001".equals(maintenanceType) && !StringUtil.isEmpty(reqJson.getString("sign")) && "1".equals(reqJson.getString("sign"))){ //有偿服务
