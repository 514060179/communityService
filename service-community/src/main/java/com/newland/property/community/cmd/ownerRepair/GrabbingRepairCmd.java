...
@NewlandPropertyCmd(serviceCode = "ownerRepair.grabbingRepair")
...
//        Assert.hasKeyAndValue(reqJson, "userName", "未包含用户名称");
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext context, JSONObject reqJson) throws CmdException, ParseException {
        ...
        try {
            ...
            if (!StringUtil.isEmpty(staffState) && "8888".equals(staffState)) { //离线状态
            ...
            if (repairDtos == null || repairDtos.size() < 1) {
                ...
                if ("1000".equals(state)) {   //1000表示未派单
                    ...
                    context.setResponseEntity(responseEntity);
                } else if ("1100".equals(state)) {   //1100表示接单
