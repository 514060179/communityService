...
@NewlandPropertyCmdDoc(title = "查询场地",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "state", type = "String", remark = "小区状态 1001 可预约状态 2002 不可以预约状态"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "startTime", type = "String", remark = "预约开始时间"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "endTime", type = "String", remark = "预约结束时间"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "feeMoney", type = "String", remark = "每小时费用"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "adminName", type = "String", remark = "管理员"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "tel", type = "String", remark = "联系电话"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "openTimes", type = "Array", remark = "联系电话"),
                @NewlandPropertyParamDoc(parentNodeName = "openTimes", name = "hours", type = "String", remark = "小时"),
                @NewlandPropertyParamDoc(parentNodeName = "openTimes", name = "isOpen", type = "String", remark = "是否预约 Y 可以预约 N 不能预约"),
        }
)
 ...
 */
@NewlandPropertyCmd(serviceCode = "communitySpace.listCommunitySpace")
