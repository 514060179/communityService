...
import com.newland.property.community.bmo.applyRoomDiscountRecord.IGetApplyRoomDiscountRecordBMO;
import com.newland.property.dto.room.ApplyRoomDiscountRecordDto;
    ...
    public ResponseEntity<String> getRecord(ApplyRoomDiscountRecordDto applyRoomDiscountRecordDto) {
        ...
        if (count > 0) {
            ...
            for (ApplyRoomDiscountRecordDto applyRoomDiscountRecord : applyRoomDiscountRecordDtoList) {
                if (!StringUtil.isEmpty(applyRoomDiscountRecord.getFileRealName()) && "19000".equals(applyRoomDiscountRecord.getRelTypeCd())) {
                ...
                } else if (!StringUtil.isEmpty(applyRoomDiscountRecord.getFileRealName()) && "21000".equals(applyRoomDiscountRecord.getRelTypeCd())) {
