...
import com.newland.property.vo.api.visit.ApiVisitVo;
...
@NewlandPropertyCmdDoc(title = "查询访客",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(name = "visits", type = "Array", remark = "有效数据"),
                @NewlandPropertyParamDoc(parentNodeName = "visits", name = "vId", type = "String", remark = "访客ID"),
                @NewlandPropertyParamDoc(parentNodeName = "visits", name = "vName", type = "String", remark = "访客名称"),
                @NewlandPropertyParamDoc(parentNodeName = "visits", name = "visitGender", type = "String", remark = "访客性别"),
                @NewlandPropertyParamDoc(parentNodeName = "visits", name = "phoneNumber", type = "String", remark = "手机号"),
                @NewlandPropertyParamDoc(parentNodeName = "visits", name = "visitTime", type = "String", remark = "访问时间"),})
...
@NewlandPropertyCmd(serviceCode = "visit.listVisits")
