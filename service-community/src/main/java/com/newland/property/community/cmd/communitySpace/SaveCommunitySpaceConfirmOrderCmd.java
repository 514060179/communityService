...
import com.newland.property.po.communitySpace.CommunitySpaceConfirmOrderPo;
...
@NewlandPropertyCmdDoc(title = "场地预约核销",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "timeId", length = 11, remark = "预约时间ID"),
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "remark", type = "String", remark = "备注"),
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "spaceName", type = "String", remark = "场地"),
 ...
 */
@NewlandPropertyCmd(serviceCode = "communitySpace.saveCommunitySpaceConfirmOrder")
public class SaveCommunitySpaceConfirmOrderCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        // todo 场地预约：核销成功通知发推送-jpush
        // appPage: /pages/reserve/reserveMyOrder?activeTab=C

        String personTel = communitySpaceConfirmOrderDtos.get(0).getPersonTel();
        ...
        messageDto.setCommunityId(communitySpacePersonTimeDto.getCommunityId());
        ...
        messageDto.setContent("您的场地预约核销成功");
