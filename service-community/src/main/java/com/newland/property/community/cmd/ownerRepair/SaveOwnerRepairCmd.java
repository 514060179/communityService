...
@NewlandPropertyCmdDoc(title = "业主报修",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "appointmentTime", length = 30, remark = "预约时间"),
        @NewlandPropertyParamDoc(name = "context", length = 30, remark = "报修内容"),
        @NewlandPropertyParamDoc(name = "photos", length = 30, remark = "报修图片"),
        @NewlandPropertyParamDoc(name = "repairName", length = 30, remark = "报修人姓名"),
        @NewlandPropertyParamDoc(name = "repairObjName", length = 30, remark = "报修人住址"),
        @NewlandPropertyParamDoc(name = "repairObjName", length = 30, remark = "报修人所在小区"),
        @NewlandPropertyParamDoc(name = "roomId", length = 30, remark = "房屋id"),
        @NewlandPropertyParamDoc(name = "tel", length = 30, remark = "报修联系电话"),
        @NewlandPropertyParamDoc(name = "userName", length = 30, remark = "业主或成员姓名"),
        @NewlandPropertyParamDoc(name = "repairChannel", length = 30, remark = "报修渠道"),
        @NewlandPropertyParamDoc(name = "repairType", length = 30, remark = "派单类型"),
        @NewlandPropertyParamDoc(name = "repairObjType", length = 30, remark = "房屋？？"),
})

@NewlandPropertyResponseDoc(
        params = {
                @NewlandPropertyParamDoc(name = "code", type = "int", length = 11, defaultValue = "0", remark = "返回编号，0 成功 其他失败"),
                @NewlandPropertyParamDoc(name = "msg", type = "String", length = 250, defaultValue = "成功", remark = "报修成功")
        }
)
...
@NewlandPropertyCmd(serviceCode = "ownerRepair.saveOwnerRepair")
