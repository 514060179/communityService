...
import com.newland.property.community.dao.IVisitV1ServiceDao;
...
public class VisitV1InnerServiceSMOImpl extends BaseServiceSMO implements IVisitV1InnerServiceSMO {
     ...
     * @param visitDto
     */
    private void syncVisitQRCodeInfo(VisitDto visitDto) {
        JSONObject reqJson = BeanConvertUtil.beanCovertJson(visitDto);
        reqJson.put("iotApiCode", "syncVisitorAccessInfoBmoImpl");
