 ...
 */
package com.newland.property.store.cmd.resourceStoreTimes;
...
@NewlandPropertyCmdDoc(title = "查询物品进货明细",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "resCode", length = 30, remark = "物品编号"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(name = "data", type = "Array", length = 0, remark = "数据"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "resCode", type = "String", length = 30,  remark = "物品编号"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "price", type = "String", length = 30,  remark = "价格"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "stock", type = "String", length = 30,  remark = "库存"),
        }
)
 ...
 */
@NewlandPropertyCmd(serviceCode = "resourceStoreTimes.listResourceStoreTimes")
