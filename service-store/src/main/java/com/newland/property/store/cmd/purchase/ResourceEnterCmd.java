package com.newland.property.store.cmd.purchase;
...
@NewlandPropertyCmdDoc(title = "采购入库",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "applyOrderId", length = 30, remark = "采购申请单订单ID"),
        @NewlandPropertyParamDoc(name = "purchaseApplyDetailVo", type = "Array", length = 30, remark = "采购物品信息"),
        @NewlandPropertyParamDoc(parentNodeName = "purchaseApplyDetailVo", name = "purchaseQuantity", type = "Int", length = 30, remark = "数量"),
        @NewlandPropertyParamDoc(parentNodeName = "purchaseApplyDetailVo", name = "price", type = "String", length = 30, remark = "价格"),
        @NewlandPropertyParamDoc(parentNodeName = "purchaseApplyDetailVo", name = "id", type = "String", length = 30, remark = "采购明细ID"),
        @NewlandPropertyParamDoc(parentNodeName = "purchaseApplyDetailVo", name = "resId", type = "String", length = 30, remark = "物品ID"),
})
 ...
 * 采购人员采购入库功能
 */
@NewlandPropertyCmd(serviceCode = "/purchase/resourceEnter")
