...
import com.newland.property.dto.shop.ShopCommunityDto;
...
@NewlandPropertyCmdDoc(title = "物业公司删除商户和商铺功能",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "shopId", length = 30, remark = "商铺编号"),
 ...
 * 此接口目前主要计划用于停车卷相关使用
 */
@NewlandPropertyCmd(serviceCode = "store.propertyDeleteStoreAndShop")
