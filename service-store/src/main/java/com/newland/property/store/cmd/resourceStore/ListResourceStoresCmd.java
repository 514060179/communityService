...
import com.newland.property.vo.api.resourceStore.ApiResourceStoreDataVo;
import com.newland.property.vo.api.resourceStore.ApiResourceStoreVo;
...
@NewlandPropertyCmdDoc(title = "查询物品",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "resCode", type = "String", remark = "物品编号"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "resName", type = "String", remark = "物品名称"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "resourceStore.listResourceStores")
