...
import com.newland.property.dto.shop.StoreShopCommunityDto;
...
import com.newland.property.intf.mall.IShopCommunityInnerServiceSMO;
...
import com.newland.property.po.shop.StoreShopPo;
import com.newland.property.po.shop.StoreShopCommunityPo;
...
@NewlandPropertyCmdDoc(title = "物业公司添加商户和商铺功能",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "shopName", length = 30, remark = "商铺名称 商家名称和商铺名称一致，如果需求需要不一致"),
        @NewlandPropertyParamDoc(name = "link", length = 30, remark = "管理员手机号"),
        @NewlandPropertyParamDoc(name = "password", length = 30, remark = "登录密码"),
 ...
 * 此接口目前主要计划用于停车卷相关使用
 */
@NewlandPropertyCmd(serviceCode = "store.propertySaveStoreAndShop")
