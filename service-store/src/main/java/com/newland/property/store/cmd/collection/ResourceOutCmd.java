package com.newland.property.store.cmd.collection;
...
@NewlandPropertyCmdDoc(title = "领用出库",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(parentNodeName = "purchaseApplyDetailVo", name = "purchaseQuantity", type = "Double", length = 30, remark = "数量"),
 ...
 * 物品领用申请出库
 */
@NewlandPropertyCmd(serviceCode = "/collection/resourceOut")
