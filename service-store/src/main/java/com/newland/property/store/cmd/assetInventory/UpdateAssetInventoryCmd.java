 ...
 */
@NewlandPropertyCmd(serviceCode = "assetInventory.updateAssetInventory")
...
/*        if (assetInventoryPo.getState() != null && assetInventoryPo.getState().equals("2000")) { //提交申请的
        ...
        if (resourceStores != null && resourceStores.size() > 0 && assetInventoryPo.getState() != null && !"4000".equals(assetInventoryPo.getState())) {
        ...
        if (assetInventoryPo.getState() != null && ("4000".equals(assetInventoryPo.getState())|| "3000".equals(assetInventoryPo.getState()))){
        ...
        if (assetInventoryPo.getState() != null && "4000".equals(assetInventoryPo.getState())){ //审核通过，更新库存
