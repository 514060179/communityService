...
import com.newland.property.intf.store.IStoreShopCommunityV1InnerServiceSMO;
...
@NewlandPropertyCmdDoc(title = "查询周围店铺",
...
@NewlandPropertyCmd(serviceCode = "store.listCommunityStoreShop")
