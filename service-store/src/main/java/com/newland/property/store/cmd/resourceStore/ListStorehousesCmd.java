...
import com.newland.property.dto.store.StorehouseDto;
...
@NewlandPropertyCmdDoc(title = "查询仓库",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "page", length = 11, type = "int", remark = "页数"),
        @NewlandPropertyParamDoc(name = "row", length = 11, type = "int", remark = "行业数"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "shName", type = "String", remark = "仓库"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "shId", type = "String", remark = "仓库ID"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "resourceStore.listStorehouses")
public class ListStorehousesCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext context, JSONObject reqJson) throws CmdException, ParseException {
        ...
        if (reqJson.containsKey("flag") && !StringUtil.isEmpty(reqJson.getString("flag")) && "1".equals(reqJson.getString("flag"))) {
        ...
        if (count > 0) {
            ...
            if (reqJson.containsKey("flag") && !StringUtil.isEmpty(reqJson.getString("flag")) && "1".equals(reqJson.getString("flag"))) {
                for (StorehouseDto storehouse : storehouseList) {
                    ...
                    } else if ("true".equals(isShow)) { //对外开放的仓库
                        storehouseDtos.add(storehouse);
                    }
                }
            } else {
