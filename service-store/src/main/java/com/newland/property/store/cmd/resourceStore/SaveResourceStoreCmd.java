 ...
 */
@NewlandPropertyCmdDoc(title = "添加物品",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "resName", length = 64, remark = "名称"),
        @NewlandPropertyParamDoc(name = "resCode", length = 64, remark = "编号"),
})
...
@NewlandPropertyCmd(serviceCode = "resourceStore.saveResourceStore")
