package com.newland.property.vo;
...
public class ResultVo implements Serializable {
    ...
    //业务校验未通过
    public static final int CODE_BUSINESS_VERIFICATION = 5010;
    //订单调度异常
    public static final int ORDER_ERROR = 500;

    // 未知异常
    public static final String MSG_ERROR = "未知异常";
    // 成功
    public static final String MSG_OK = "成功";
    //认证失败
    public static final String MSG_UNAUTHORIZED = "认证失败";

    public static final int DEFAULT_RECORD = 1;
    public static final int DEFAULT_TOTAL = 1;
    // 支付未完成
    public static final int CODE_WAIT_PAY = 41;
