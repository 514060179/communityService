package com.newland.property.dto.parking;
...
public class ParkingAreaDto extends PageDto implements Serializable {
    ...
    private String thirdAreaNum; //外部编码（从attrs提取，方便使用）
    ...
    public void setThirdAreaNum(String thirdAreaNum) {
        this.thirdAreaNum = thirdAreaNum;
    }
}
