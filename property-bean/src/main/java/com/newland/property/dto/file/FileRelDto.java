package com.newland.property.dto.file;
...
public class FileRelDto extends PageDto implements Serializable {
    ...
    //报修图片
    public static final String REL_TYPE_CD_REPAIR = "14000";
    //租赁图片
    public static final String REL_TYPE_CD_RENTING = "16000";
    //商品封面
    public static final String REL_TYPE_CD_GOODS_COVER = "17000";
    //商品轮播
    public static final String REL_TYPE_CD_GOODS_CAROUSEL_FIGURE = "18000";
    //租赁图片
    public static final String SAVE_WAY_FTP = "ftp";
    //维修前图片
    public static final String BEFORE_REPAIR_PHOTOS = "23000";
    //维修后图片
    public static final String AFTER_REPAIR_PHOTOS = "24000";
    //发票
    public static final String REL_TYPE_CE_INVOICE = "29000";
