...
public class FeeAttrDto extends PageDto implements Serializable {
    ...
    // 报修单ID
    public static final String SPEC_CD_REPAIR = "390001";
    //导入费用名称
    public static final String SPEC_CD_IMPORT_FEE_NAME = "390002";
    //公摊用量
    public static final String SPEC_CD_SHARE_DEGREES = "390003";
    //公摊总用量
    public static final String SPEC_CD_TOTAL_DEGREES = "390004";
    //公摊公式
    public static final String SPEC_CD_SHARE_FORMULA = "390005";
    //用量
    public static final String SPEC_CD_PROXY_CONSUMPTION = "390006";
    // 截止时间
    public static final String SPEC_CD_ONCE_FEE_DEADLINE_TIME = "390010";
    //业主ID
    public static final String SPEC_CD_OWNER_ID = "390007";
    //业主名称
    public static final String SPEC_CD_OWNER_NAME = "390008";
    //业主联系方式
    public static final String SPEC_CD_OWNER_LINK = "390009";
    //车辆进场编号
    public static final String SPEC_CD_CAR_INOUT_ID = "390011";
    //付费对象名称
    public static final String SPEC_CD_PAY_OBJECT_NAME = "390012";
    //费用套餐ID
    public static final String SPEC_CD_COMBO_ID = "390013";
    //递增周期
    public static final String SPEC_CD_RATE_CYCLE = "390014";
    //递增率
    public static final String SPEC_CD_RATE = "390015";
    //递增开始时间
    public static final String SPEC_CD_RATE_START_TIME = "390016";
