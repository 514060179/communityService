package com.newland.property.dto.attendance;
...
public class AttendanceClassesTaskDetailDto extends PageDto implements Serializable {
    ...
    //补考勤
    public static final String STATE_REPLENISH = "70000";
    //补考勤
    public static final String STATE_WAIT = "10000";
    //正常考勤
    public static final String STATE_NORMAL = "30000";
    //迟到
    public static final String STATE_LATE = "40000";
    //早退
    public static final String STATE_LEAVE = "50000";
    //上班时间
    public static final String SPEC_CD_START = "1001" ;
    //上班时间
    public static final String SPEC_CD_END = "2002" ;
