package com.newland.property.dto.purchase;
...
public class PurchaseApplyDto extends PageDto implements Serializable {
    ...
    //采购入库
    public static final String RES_ORDER_TYPE_ENTER = "10000";
    //出库
    public static final String RES_ORDER_TYPE_OUT = "20000";
    // 等待处理
    public static final String STATE_WAIT_DEAL = "1000";
    // 审核中
    public static final String STATE_DEALING = "1001";
    // 已审核
    public static final String STATE_AUDITED = "1002";
    // 完结
    public static final String STATE_END = "1003";
    // 未通过
    public static final String STATE_NOT_PASS = "1004";
    // 直接入库/出库
    public static final String WAREHOUSING_TYPE_DIRECT = "10000";
    // 采购申请入库/出库
    public static final String WAREHOUSING_TYPE_APPLY = "20000";
    //紧急采购入库
    public static final String WAREHOUSING_TYPE_URGENT = "30000";
    //计算均价
    public static final String WEIGHTED_MEAN_TRUE = "10000";
