package com.newland.property.dto.visit;
...
public class VisitDto extends PageDto implements Serializable {
    ...
    //待审核
    public static final String STATE_W = "0";
    //表示审核通过
    public static final String STATE_C = "1";
    //表示审核拒绝
    public static final String STATE_F = "2";
    // 审核中
    public static final String STATE_D = "3";

    //车辆审核状态 0表示未审核；1表示审核通过；2表示审核拒绝
    //待审核
    public static final String CAR_STATE_W = "0";
    //表示审核通过
    public static final String CAR_STATE_C = "1";
    //表示审核拒绝
    public static final String CAR_STATE_F = "2";
    // 审核中
    public static final String CAR_STATE_D = "3";
