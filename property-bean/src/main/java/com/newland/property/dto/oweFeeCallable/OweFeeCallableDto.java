package com.newland.property.dto.oweFeeCallable;
...
public class OweFeeCallableDto extends PageDto implements Serializable {
    ...
    //状态 W 带催缴 C 催缴完成 F催缴失败 D 催缴中
    public static final String CALLABLE_WAY_WECHAT = "WECHAT";
    //催缴方式： WECHAT 微信 SMS 短信 PRINT 上门催缴
    public static final String CALLABLE_WAY_SMS = "SMS";
    //催缴方式： WECHAT 微信 SMS 短信 PRINT 上门催缴
    public static final String CALLABLE_WAY_PRINT = "PRINT";

    public static final String CALLABLE_WAY_JPUSH = "JPUSH";
