package com.newland.property.dto.notice;
...
public class NoticeDto extends PageDto implements Serializable {
    ...
    //通知中
    public static final String STATE_DOING = "2000";
    //通知完成
    public static final String STATE_FINISH = "3000";
    //小区
    public static final String OBJ_TYPE_COMMUNITY = "001";
    //楼栋
    public static final String OBJ_TYPE_FLOOR = "002";
    //单元
    public static final String OBJ_TYPE_UNIT = "003";
    //房屋
    public static final String OBJ_TYPE_ROOM = "004";
    //全部发送
    public static final String OBJ_TYPE_ALL = "005";
    //发送给业主微信
    public static final String NOTICE_TYPE_OWNER_WECHAT = "1003";
