...
public class FeeDto extends PageDto implements Serializable {
    ...
    // 收费结束
    public static final String STATE_FINISH = "2009001";
    // 收费中
    public static final String STATE_DOING = "2008001";
    // 收费未开始
    public static final String STATE_UNDO = "2007001";


    //房屋 6666 是车位
    public static final String PAYER_OBJ_TYPE_ROOM = "3333";
    //是车位
    public static final String PAYER_OBJ_TYPE_PARKING_SPACE = "6666";
    //是合同
    public static final String PAYER_OBJ_TYPE_CONTRACT = "7777";
    //是车位
    public static final String PAYER_OBJ_TYPE_CAR = "6666";
    //房源ID
    public static final String PAYER_OBJ_TYPE_RENTING = "9999";
    //一次性费用
    public static final String FEE_FLAG_ONCE = "2006012";
    //周期性费用
    public static final String FEE_FLAG_CYCLE = "1003006";
    //间接性费用
    public static final String FEE_FLAG_CYCLE_ONCE = "4012024";
