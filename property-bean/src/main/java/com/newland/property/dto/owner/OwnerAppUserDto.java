...
public class OwnerAppUserDto extends PageDto implements Serializable {
    ...
    //小程序绑定业主
    public static final String APP_TYPE_WECHAT_MINA = "WECHAT_MINA";
    //公众号绑定业主
    public static final String APP_TYPE_WECHAT = "WECHAT";
    // 审核中
    public static final String STATE_AUDITING = "10000";
    //审核成功
    public static final String STATE_AUDIT_SUCCESS = "12000";
    //审核失败
    public static final String STATE_AUDIT_ERROR = "13000";
