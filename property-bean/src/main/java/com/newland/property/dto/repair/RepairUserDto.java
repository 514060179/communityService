...
public class RepairUserDto extends PageDto implements Serializable {
    ...
    // 处理中
    public static final String STATE_DOING = "10001";
    // 结单
    public static final String STATE_CLOSE = "10002";
    // 退单
    public static final String STATE_BACK = "10003";
    // 转单
    public static final String STATE_TRANSFER = "10004";
    // 提交
    public static final String STATE_SUBMIT = "10005";
    //派单
    public static final String STATE_DISPATCH = "10006";
    //评价完成
    public static final String STATE_FINISH = "10007";
    //已回访
    public static final String STATE_FINISH_VISIT = "10008";
    //待支付
    public static final String STATE_PAY_FEE = "10009";
    //评价回复
    public static final String STATE_REPLY_APPRAISE = "10010";
    //待评价
    public static final String STATE_EVALUATE = "11000";
    //已支付
    public static final String STATE_FINISH_PAY_FEE = "12000";
    //暂停
    public static final String STATE_STOP = "12001";
    //启动
    public static final String STATE_START = "12002";
