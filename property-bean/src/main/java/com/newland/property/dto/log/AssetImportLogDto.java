package com.newland.property.dto.log;
...
public class AssetImportLogDto extends PageDto implements Serializable {
    ...
    //状态 W 待处理 D 处理中 C 处理完成
    public static final String STATE_WAIT_IMPORT = "W";
    //状态 W 待处理 D 处理中 C 处理完成
    public static final String STATE_DOING_IMPORT = "D";
    //状态 W 待处理 D 处理中 C 处理完成
    public static final String STATE_COMPLETE_IMPORT = "C";
