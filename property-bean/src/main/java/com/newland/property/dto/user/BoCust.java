...
public class BoCust extends DefaultBoEntity implements Comparable<BoCust> {
    ...
    // 普通客户
    private final static String CUST_TYPE_GENERAL= "1";
    // 管理员
    private final static String CUST_TYPE_MANAGER="2";
    //超级管理
    private final static String CUST_TYPE_ADMINISTRATOR="3";
    //微信用户
    private final static String CUST_TYPE_WECHAT="4";
    //支付宝用户
    private final static String CUST_TYPE_ALIPAY="5";
    //github用户
    private final static String CUST_TYPE_GITHUB="6";
    //sina 用户
    private final static String CUST_TYPE_SINA="7";
    //QQ 用户
    private final static String CUST_TYPE_QQ="8";
