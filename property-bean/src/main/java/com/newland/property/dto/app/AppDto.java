...
public class AppDto extends PageDto implements Serializable {
    ...
    // 微信支付
    public static final String OWNER_WECHAT_PAY = "992020011134400001";
    // app微信支付
    public static final String OWNER_APP_APP_ID = "992020061440050003";
    // 定时任务应用
    public static final String JOB_APP_ID = "992021061746360004";
