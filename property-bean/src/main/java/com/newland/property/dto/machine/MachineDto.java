...
public class MachineDto extends PageDto implements Serializable {
    ...
    // 监控
    public static final String MACHINE_TYPE_MONITOR = "9998";
    public static final String MACHINE_STATE_ON = "1200";
    public static final String MACHINE_STATE_OFF = "1300";
    //进场
    public static final String DIRECTION_IN = "3306";
    //出场
    public static final String DIRECTION_OUT = "3307";

    // 海康平台
    public static final String HM_HK = "16";
