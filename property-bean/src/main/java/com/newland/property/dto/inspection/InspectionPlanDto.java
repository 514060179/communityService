package com.newland.property.dto.inspection;
...
public class InspectionPlanDto extends PageDto implements Serializable {
    ...
    // 连续每天
    public static final String INSPECTION_PLAN_PERIOD_DAY = "2020022";
    // 连续每周
    public static final String INSPECTION_PLAN_PERIOD_WEEK = "2020023";
    // 连续隔天
    public static final String INSPECTION_PLAN_PERIOD_NEXT_DAY = "2020024";
