...
public class AllocationStorehouseDto extends PageDto implements Serializable {
    // 状态，1200 调拨申请 1201 调拨审核 1202 调拨完成 1203 调拨失败 1204 调拨已审核 1205 已退还
    public static final String STATE_APPLY = "1200";
    // 状态，1200 调拨申请 1201 调拨审核 1202 调拨完成 1203 调拨失败 1204 调拨已审核 1205 已退还
    public static final String STATE_AUDIT = "1201";
    // 状态，1200 调拨申请 1201 调拨审核 1202 调拨完成 1203 调拨失败 1204 调拨已审核 1205 已退还
    public static final String STATE_SUCCESS = "1202";
    // 状态，1200 调拨申请 1201 调拨审核 1202 调拨完成 1203 调拨失败 1204 调拨已审核 1205 已退还
    public static final String STATE_FAIL = "1203";
    // 状态，1200 调拨申请 1201 调拨审核 1202 调拨完成 1203 调拨失败 1204 调拨已审核 1205 已退还
    public static final String STATE_REVIEWED = "1204";
    // 状态，1200 调拨申请 1201 调拨审核 1202 调拨完成 1203 调拨失败 1204 调拨已审核 1205 已退还
