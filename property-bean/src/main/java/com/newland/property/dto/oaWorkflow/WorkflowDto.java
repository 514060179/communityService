...
public class WorkflowDto extends PageDto implements Serializable {
    ...
    //物品领用
    public static final String FLOW_TYPE_COLLECTION = "40004";

    //合同申请续签审核
    public static final String FLOW_TYPE_CONTRACT_APPLY = "50005";

    //合同变更审核
    public static final String FLOW_TYPE_CONTRACT_CHANGE = "60006";


    //物品调拨
    public static final String FLOW_TYPE_ALLOCATION_STOREHOUSE = "70007";

    //物品被调拨
    public static final String FLOW_TYPE_ALLOCATION_STOREHOUSE_GO = "80008";



    public static final String DEFAULT_SKIP_LEVEL = "1";

    public static final String DEFAULT_PROCESS = "newland_" ;
