package com.newland.property.dto.workPoolFile;
...
public class WorkPoolFileDto extends PageDto implements Serializable {
    ...
    //文件类型,S 工作单附件，J 任务图片 E 任务附件
    public static final String FILE_TYPE_START = "S";
    //文件类型,S 工作单附件，J 任务图片 E 任务附件
    public static final String FILE_TYPE_JPG = "J";
    //文件类型,S 工作单附件，J 任务图片 E 任务附件
    public static final String FILE_TYPE_END = "E";
