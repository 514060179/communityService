...
public class FeeDiscountRuleDto extends PageDto implements Serializable {
    ...
    //1: 打折
    public static final String DISCOUNT_SMALL_TYPE_DISCOUNT = "1";
    //2:减免
    public static final String DISCOUNT_SMALL_TYPE_DEDUCTION = "2";
    //3:滞纳金
    public static final String DISCOUNT_SMALL_TYPE_LATE = "3";
    //4:空置房打折
    public static final String DISCOUNT_SMALL_TYPE_APPLY_DISCOUNT = "4";
    //5:空置房减免
    public static final String DISCOUNT_SMALL_TYPE_APPLY_DEDUCTION = "5";
    //6:赠送
    public static final String DISCOUNT_SMALL_TYPE_GIFT = "6";
