...
public class OwnerCarDto extends PageDto implements Serializable {
    ...
    //销户
    public static final String STATE_DELETE = "4004";

    //主车辆
    public static final String CAR_TYPE_PRIMARY = "1001";
    //车辆成员
    public static final String CAR_TYPE_MEMBER = "1002";
    //临时车
    ...
    // 月租车
    public static final String LEASE_TYPE_MONTH = "H";
    // 出售车
    public static final String LEASE_TYPE_SALE = "S";
    //内部车
    public static final String LEASE_TYPE_INNER = "I";
    //免费车
    public static final String LEASE_TYPE_NO_MONEY = "NM";
    //预约车
    public static final String LEASE_TYPE_RESERVE = "R";
    //临时车
    public static final String LEASE_TYPE_TEMP = "T";
    //信用期车牌
    public static final String CAR_TYPE_CREDIT = "9906";
