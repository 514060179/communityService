...
public class RepairDto extends PageDto implements Serializable {
    ...
    //抢单模式
    public static final String REPAIR_WAY_GRABBING = "100";
    //指派模式
    public static final String REPAIR_WAY_ASSIGN = "200";
    //轮训模式
    public static final String REPAIR_WAY_TRAINING = "300";

    //报修渠道  D员工代客报修  T电话报修 Z业主自主保修
    //D员工代客报修
    public static final String REPAIR_CHANNEL_STAFF = "D";
    //T电话报修
    public static final String REPAIR_CHANNEL_TEL = "T";
    //Z业主自主保修
    public static final String REPAIR_CHANNEL_OWNER = "Z";
