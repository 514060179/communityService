package com.newland.property.dto.room;
...
public class RoomDto extends PageDto implements Serializable {
    ...
    //已交房
    public static final String STATE_DELIVERY = "2003";
    //未入住
    public static final String STATE_NO_HOME = "2004";
    //已装修
    public static final String STATE_RENOVATION = "2005";
    //已出租
    public static final String STATE_SHOP_FIRE = "2006";
    //已售
    public static final String STATE_SHOP_SELL = "2007";
    //空闲
    public static final String STATE_SHOP_FREE = "2008";
    //装修中
    public static final String STATE_SHOP_REPAIR = "2009";
    //普通房屋
    public static final String ROOM_TYPE_ROOM = "1010301";
    //商铺
    public static final String ROOM_TYPE_SHOPS = "2020602";
