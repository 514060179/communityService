...
public class UserDto extends PageDto implements Serializable {
    ...
    //商城用户
    public static final String LEVEL_CD_MALL = "03";
    //系统管理员
    public static final String LEVEL_CD_ADMIN = "00";
    //员工
    public static final String LEVEL_CD_STAFF = "01";
    //普通用户
    public static final String LEVEL_CD_USER = "02";
