package com.newland.property.dto.reportData;
...
public class ReportDataHeaderDto implements Serializable {
    ...
    //已发送
    public static final String RETUR_CODE= "1001";
    //处理成功
    public static final String RETUR_SUCCESS_CODE= "2002";
    //处理失败
    public static final String RETUR_ERROR_CODE= "3003";
    //重新发送
    public static final String RETUR_AGAIN_CODE= "4004";
