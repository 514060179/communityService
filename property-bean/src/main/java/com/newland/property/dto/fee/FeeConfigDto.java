...
public class FeeConfigDto extends PageDto implements Serializable {
    ...
    // 按年出账
    public static final String BILL_TYPE_YEAR = "001";
    // 每月1日
    public static final String BILL_TYPE_MONTH = "002";
    // 每日
    public static final String BILL_TYPE_DAY = "003";
    // 实时
    public static final String BILL_TYPE_EVERY = "004";
    // 一次性按月
    public static final String BILL_TYPE_ONCE_MONTH = "005";

    public static final String DEFAULT_FEE_CONFIG = "T";
    public static final String CUSTOME_FEE_CONFIG = "F";

    //电费
    public static final String FEE_TYPE_CD_WATER = "888800010016";
    //水费
    public static final String FEE_TYPE_CD_METER = "888800010015";
    //煤气
    public static final String FEE_TYPE_CD_GAS = "888800010009";
    //系统
    public static final String FEE_TYPE_CD_SYSTEM = "888800010000";
    //停车
    public static final String FEE_TYPE_CD_PARKING = "888800010008";
    // 租金
    public static final String FEE_TYPE_CD_RENT = "888800010018";
    //租赁费用项
    public static final String CONFIG_ID_RENTING = "920000000000000000";
    //商品费用项
    public static final String CONFIG_ID_GOODS = "930000000000000000";

    public static final String COMPUTING_FORMULA_TEMP_CAR = "9999";
    // 租金递增
    public static final String COMPUTING_FORMULA_RANT_RATE = "1102";
    // 租金递增
    public static final String COMPUTING_FORMULA_DYNAMIC = "4004";
