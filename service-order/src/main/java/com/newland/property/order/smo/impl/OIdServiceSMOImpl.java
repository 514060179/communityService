...
import com.newland.property.order.smo.IAsynNotifySubService;
import com.newland.property.order.smo.IOIdServiceSMO;
import com.newland.property.utils.cache.BusinessTableHisCache;
    ...
    public ResponseEntity<String> fallBackOId(OrderDto orderDto) {
        ...
        for (OrderItemDto orderItemDto : orderItemDtos) {
            try {
                ...
                } else if (!StringUtil.isEmpty(orderItemDto.getActionObj()) && !"meter_water".equals(orderItemDto.getActionObj())) {
