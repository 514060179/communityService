...
@NewlandPropertyCmdDoc(title = "特来电获取token",
...
@NewlandPropertyParamsDoc(
        headers = {
                @NewlandPropertyHeaderDoc(name = "Content-Type", defaultValue = "application/json", description = "application/json"),
        },
        params = {
                @NewlandPropertyParamDoc(name = "OperatorID", length = 30, remark = "调用方的组织机构代码"),
                @NewlandPropertyParamDoc(name = "OperatorSecret", length = 30, remark = "服务方分配的唯一识别密钥"),
        })

@NewlandPropertyResponseDoc(
        params = {
                @NewlandPropertyParamDoc(name = "Ret", type = "int", length = 11, defaultValue = "0", remark = "返回编号，0 成功 其他失败"),
                @NewlandPropertyParamDoc(name = "Msg", type = "int", length = 11, defaultValue = "0", remark = "返回编号，0 成功 其他失败"),
                @NewlandPropertyParamDoc(name = "Data", type = "Object", remark = "有效数据"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "TokenAvailableTime", type = "int", remark = "有效期"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "AccessToken", type = "String", remark = "临时票据"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "query_token")
