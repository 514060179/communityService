...
@NewlandPropertyCmdDoc(title = "招商平台企业信息同步",
        description = "同步企业信息",
        httpMethod = "post",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "communityId", length = 30, remark = "物业系统小区ID"),
        @NewlandPropertyParamDoc(name = "enterpriseArea", length = 64, remark = "办公面积"),
        @NewlandPropertyParamDoc(name = "enterpriseAssets", length = 64, remark = "企业资产"),
        @NewlandPropertyParamDoc(name = "enterpriseIncome", length = 64, remark = "企业收入"),
        @NewlandPropertyParamDoc(name = "enterpriseMember", length = 64, remark = "办公人数"),
        @NewlandPropertyParamDoc(name = "enterpriseOutput", length = 64, remark = "企业产值"),
        @NewlandPropertyParamDoc(name = "enterpriseSize", length = 64, remark = "企业规模"),
        @NewlandPropertyParamDoc(name = "enterpriseTax", length = 64, remark = "企业税收"),
        @NewlandPropertyParamDoc(name = "enterpriseType", length = 64, remark = "企业类型(未定义，暂定1，五百强，2上市)"),
        @NewlandPropertyParamDoc(name = "financingInfo", length = 64, remark = "融资信息"),
        @NewlandPropertyParamDoc(name = "inTime", length = 64, remark = "入驻时间"),
        @NewlandPropertyParamDoc(name = "industry", length = 64, remark = "所属行业"),
        @NewlandPropertyParamDoc(name = "label", length = 64, remark = "企业标签"),
        @NewlandPropertyParamDoc(name = "legalPerson", length = 64, remark = "法人"),
        @NewlandPropertyParamDoc(name = "scienceEnterprise", length = 64, remark = "科技型企业：如民营科技企业"),
        @NewlandPropertyParamDoc(name = "shopName", length = 64, remark = "店铺名称"),
        @NewlandPropertyParamDoc(name = "superAdmin", length = 64, remark = "超级管理员号码"),
        @NewlandPropertyParamDoc(name = "website", length = 64, remark = "官网地址"),
        @NewlandPropertyParamDoc(name = "years", length = 64, remark = "成立年限：如1-3年"),
        @NewlandPropertyParamDoc(name = "contactInfo", length = 64, remark = "联系方式"),
        @NewlandPropertyParamDoc(name = "creditCode", length = 64, remark = "统一信用代码"),
        @NewlandPropertyParamDoc(name = "enterpriseAddress", length = 64, remark = "企业地址"),
        @NewlandPropertyParamDoc(name = "enterpriseName", length = 64, remark = "企业名称"),
        @NewlandPropertyParamDoc(name = "introduction", length = 256, remark = "简介"),
        @NewlandPropertyParamDoc(name = "licenseImg", length = 64, remark = "营业执照图片"),
})
 ...
 * 提供招商平台
 */
@NewlandPropertyCmd(serviceCode = "owner.syncThirdEnterprise")
