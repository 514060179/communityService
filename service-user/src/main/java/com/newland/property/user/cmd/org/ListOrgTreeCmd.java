...
import com.newland.property.dto.org.OrgTreeDto;
...
@NewlandPropertyCmdDoc(title = "查询组织",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "orgId", length = 30, remark = "组织ID，非必填"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "allOrgName", type = "String", remark = "组织名称"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "id", type = "String", remark = "组织ID"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "children", type = "Array", remark = "子节点"),
                @NewlandPropertyParamDoc(parentNodeName = "children",name = "allOrgName", type = "String", remark = "组织名称"),
                @NewlandPropertyParamDoc(parentNodeName = "children",name = "id", type = "String", remark = "组织ID"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "org.listOrgTree")
