...
@NewlandPropertyCmdDoc(title = "运营团队admin登录到物业账号",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "username", length = 30, remark = "需要登录的用户"),
        @NewlandPropertyParamDoc(name = "userId", length = 30, remark = "需要登录的用户ID"),
        @NewlandPropertyParamDoc(name = "curPasswd", length = 30, remark = "当前用户密码"),
        @NewlandPropertyParamDoc(name = "curUserName", length = 64, remark = "当前用户"),
})
...
@NewlandPropertyCmd(serviceCode = "login.adminLoginProperty")
