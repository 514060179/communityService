...
@NewlandPropertyCmdDoc(title = "修改业主",
...
@NewlandPropertyCmd(serviceCode = "owner.editOwner")
...
//        }
    ...
    private void updateOwnerAppUser(JSONObject reqJson) {
        ...
        for (OwnerAppUserDto ownerAppUser : ownerAppUserDtos) {
            ...
            ownerAppUserPo.setAreaCode(reqJson.getString("areaCode"));
            ownerAppUserPo.setAppUserName(reqJson.getString("name"));
            ...
            if (!ownerAppUserDtos.get(0).getLink().equals(reqJson.getString("link"))) {
                userPo.setPassword(AuthenticationFactory.passwdMd5(reqJson.getString("link")));
            }
