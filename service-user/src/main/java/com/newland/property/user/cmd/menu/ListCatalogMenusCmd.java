 ...
 */
package com.newland.property.user.cmd.menu;
 ...
 */
@NewlandPropertyCmd(serviceCode = "menu.listCatalogMenus")
public class ListCatalogMenusCmd extends Cmd {
    ...
    public void doCmd(CmdEvent event, ICmdDataFlowContext cmdDataFlowContext, JSONObject reqJson) throws CmdException {
        ...
        String lang = cmdDataFlowContext.getReqHeaders().get(CommonConstant.PROPERTY_LANG);
