...
@NewlandPropertyCmdDoc(title = "重置密码",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "staffId", length = 30, remark = "员工ID"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(name = "pwd", type = "String", length = 250,  remark = "密码"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "user.resetStaffPwd")
