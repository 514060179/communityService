 ...
 */
package com.newland.property.user.cmd.menuGroupCommunity;
...
import com.newland.property.intf.user.IMenuGroupV1InnerServiceSMO;
 ...
 */
@NewlandPropertyCmd(serviceCode = "menuGroupCommunity.updateMenuGroupCommunity")
