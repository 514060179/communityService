...
@NewlandPropertyCmdDoc(title = "单点登录获取accessToken",
...
@NewlandPropertyParamsDoc(
        ...
        params = {
                @NewlandPropertyParamDoc(name = "tel", length = 30, remark = "用户名，物业系统分配"),
                @NewlandPropertyParamDoc(name = "passwd", length = 30, remark = "密码，物业系统分配"),        })
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "expiresIn", type = "String", remark = "票据过期时间单位秒"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "login.getAccessToken")
