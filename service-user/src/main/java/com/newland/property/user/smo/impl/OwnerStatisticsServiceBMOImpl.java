...
/**
 * @ClassName OwnerStatisticsBMOImpl
 * @Description 业主数据统计实现类
 * @Author wuxw
 * @Date 2019/4/24 9:20
 * @Version 1.0
 ...
 **/
@RestController
public class OwnerStatisticsServiceBMOImpl extends BaseServiceSMO implements IOwnerStatisticsServiceBMO {
