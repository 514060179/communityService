...
import com.newland.property.vo.api.staff.ApiStaffDataVo;
import com.newland.property.vo.api.staff.ApiStaffVo;
...
@NewlandPropertyCmdDoc(title = "查询员工",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "staffName", length = 64, remark = "员工名称"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(name = "staffs", type = "Object", remark = "有效数据"),
                @NewlandPropertyParamDoc(parentNodeName = "staffs",name = "userId", type = "String", remark = "员工ID"),
                @NewlandPropertyParamDoc(parentNodeName = "staffs",name = "name", type = "String", remark = "员工名称"),
                @NewlandPropertyParamDoc(parentNodeName = "staffs",name = "orgName", type = "String", remark = "组织"),
                @NewlandPropertyParamDoc(parentNodeName = "staffs",name = "orgId", type = "String", remark = "组织ID"),
                @NewlandPropertyParamDoc(parentNodeName = "staffs",name = "relCdName", type = "String", remark = "岗位"),
                @NewlandPropertyParamDoc(parentNodeName = "staffs",name = "tel", type = "String", remark = "手机号"),
                @NewlandPropertyParamDoc(parentNodeName = "staffs",name = "address", type = "String", remark = "地址"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "query.staff.infos")
