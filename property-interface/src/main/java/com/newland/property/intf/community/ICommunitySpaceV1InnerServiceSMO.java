...
public interface ICommunitySpaceV1InnerServiceSMO {
     ...
     *
     *
     * @param communitySpaceFileDto 数据对象分享
     * @return CommunitySpaceDto 对象数据
     */
    @RequestMapping(value = "/queryCommunitySpaceFiles", method = RequestMethod.POST)
    List<CommunitySpaceFileDto> queryCommunitySpaceFiles(@RequestBody CommunitySpaceFileDto communitySpaceFileDto);
     ...
     * @return 小区下的小区楼记录数
     */
    @RequestMapping(value = "/queryCommunitySpaceFilesCount", method = RequestMethod.POST)
    int queryCommunitySpaceFilesCount(@RequestBody CommunitySpaceFileDto communitySpaceFileDto);
}
