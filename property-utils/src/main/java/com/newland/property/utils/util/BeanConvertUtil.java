...
public final class BeanConvertUtil {
    ...
    static {
        ...
        ConvertUtils.register(new NewlandPropertyStringConvert(), String.class);
    }
    ...
    public static <T1, T2> T2 covertBean(T1 orgBean, T2 dstBean) {
        ...
        try {
            ...
            beanCopier.copy(orgBean, dstBean, new NewlandPropertyConverter());
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static void objectFieldsPutMap(Object dstBean, BeanMap beanMap, Map<String, Object> orgMap) {
        ...
        for (Field field : fields) {
            ...
            //String 转date
            Object tmpValue = NewlandPropertyConverter.getValue(value, dstClass);
