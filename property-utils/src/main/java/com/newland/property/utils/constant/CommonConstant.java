...
public class CommonConstant {
     ...
     * 鉴权token
     */
    public final static String COOKIE_AUTH_TOKEN = "_newland_property_token_";

    public final static String DEFAULT_USER_PWD_SECRET = "@newland.com";

    /**
     * 默认JWT 秘钥
     */
    public final static String DEFAULT_JWT_SECRET = "@newland_property_JWT";


    /**
     * 默认过期时间
     */
    public final static String DEFAULT_JWT_EXPIRE_TIME = 30 * 24 * 60 * 60 + "";
    ...
    public static final String PROPERTY_LANG = "property-lang";
    ...
    public static final String USER_LATEST_JWT_TOKEN = "USER_LATEST_JWT_TOKEN_";

    public static final String DEFAULT_LOGIN_OTHER_DEVICE = "您的账号已在别的设备登录，请重新登录";

    public static final String DEFAULT_ONE_DEVICE_LOGIN_WHITE_LIST = "8000418004";
}