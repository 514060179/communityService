...
public final class MappingConstant {
     ...
     * 账号在别的设备登录提示
     */
    public static final String DOMAIN_COMMON_LOGIN_OTHER_DEVICE = "LOGIN_OTHER_DEVICE";

    public static final String  ONE_DEVICE_LOGIN_WHITE_LIST = "ONE_DEVICE_LOGIN_WHITE_LIST";
}
