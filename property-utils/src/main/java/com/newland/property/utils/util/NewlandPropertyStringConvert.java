 ...
 * 自定义 String 处理
 */
public class NewlandPropertyStringConvert extends AbstractConverter {
    private static Logger logger = LoggerFactory.getLogger(NewlandPropertyStringConvert.class);
     ...
     */
    public NewlandPropertyStringConvert() {
        super();
    }
     ...
     */
    public NewlandPropertyStringConvert(Object defaultValue) {
        super(defaultValue);
    }
