package com.newland.property.utils.cache;

import com.newland.property.dto.system.BusinessTableHisDto;
import com.newland.property.utils.util.SerializeUtil;
...
public class BusinessTableHisCache extends BaseCache {
    ...
    public final static String DEFAULT_BUSINESS_TABLE_HIS = "NEWLANDPROPERTY_BUSINESS_TABLE_HIS";
