package com.newland.property.db;
...
public class NewlandPropertyMybatisInterceptor implements Interceptor {
    private static Logger logger = LoggerFactory.getLogger(NewlandPropertyMybatisInterceptor.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        if (StringUtil.isEmpty(PropertyTransactionalFactory.getOId())) { //未开启事务
    ...
    private void dealDeleteSql(MappedStatement mappedStatement, Object parameter, String sql, Map<String, Object> sqlValue) {
        ...
        orderItemDto.setoId(PropertyTransactionalFactory.getOId());
    ...
    public String showSql(Configuration configuration, BoundSql boundSql, Map<String, Object> sqlValue, SqlCommandType sqlCommandType) {
        ...
        //TODO TODO TODO  这里有bug, 任意key没set值，后续自动生成的business_xxx sql就会错
