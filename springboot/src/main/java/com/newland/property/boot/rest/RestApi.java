package com.newland.property.boot.rest;

import com.alibaba.fastjson.JSONObject;
import com.newland.property.boot.smo.IApiServiceSMO;
import com.newland.property.core.base.controller.BaseController;
import com.newland.property.core.log.LoggerFactory;
import com.newland.property.doc.annotation.NewlandPropertyApiDoc;
import com.newland.property.doc.annotation.NewlandPropertyRequestMappingDoc;
import com.newland.property.doc.annotation.NewlandPropertyRequestMappingsDoc;
...
@NewlandPropertyRequestMappingsDoc(
        mappingsDocs = {
                @NewlandPropertyRequestMappingDoc(name = "用户中心", resource = "userDoc", url = "http://127.0.0.1:8008", seq = 1, startWay = "boot"),
                @NewlandPropertyRequestMappingDoc(name = "资产中心", resource = "communityDoc", url = "http://127.0.0.1:8008", seq = 2, startWay = "boot"),
                @NewlandPropertyRequestMappingDoc(name = "商户中心", resource = "storeDoc", url = "http://127.0.0.1:8008", seq = 3, startWay = "boot"),
                @NewlandPropertyRequestMappingDoc(name = "账户中心", resource = "acctDoc", url = "http://127.0.0.1:8008", seq = 4, startWay = "boot"),
                @NewlandPropertyRequestMappingDoc(name = "通用中心", resource = "commonDoc", url = "http://127.0.0.1:8008", seq = 5, startWay = "boot"),
                @NewlandPropertyRequestMappingDoc(name = "费用中心", resource = "feeDoc", url = "http://127.0.0.1:8008", seq = 6, startWay = "boot"),
                @NewlandPropertyRequestMappingDoc(name = "报表中心", resource = "reportDoc", url = "http://127.0.0.1:8008", seq = 7, startWay = "boot"),
        }
)
