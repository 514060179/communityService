...
import com.newland.property.boot.smo.payment.IToPayTempCarInoutSMO;
...
public class ToPayTempCarInoutSMOImpl extends AppAbstractComponentSMO implements IToPayTempCarInoutSMO {
    ...
    protected ResponseEntity<String> doBusinessProcess(IPageData pd, JSONObject paramIn) throws Exception {
        ...
        Map result = tPayAdapt.newlandPropertyPayment(restTemplate, paramIn.getString("feeName"), paramIn.getString("tradeType"),
