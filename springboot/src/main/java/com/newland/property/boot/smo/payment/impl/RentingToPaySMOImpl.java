...
import com.newland.property.boot.smo.payment.IRentingToPaySMO;
...
public class RentingToPaySMOImpl extends AppAbstractComponentSMO implements IRentingToPaySMO {
    ...
    protected ResponseEntity<String> doBusinessProcess(IPageData pd, JSONObject paramIn) throws Exception {
        ...
        Map result = tPayAdapt.newlandPropertyPayment(outRestTemplate, feeName, WechatAuthProperties.TRADE_TYPE_NATIVE, orderId, money, "", smallWeChatDto, wechatAuthProperties.getRentingNotifyUrl());
