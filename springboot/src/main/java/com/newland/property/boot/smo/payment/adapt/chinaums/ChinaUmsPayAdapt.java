 ...
 */
package com.newland.property.boot.smo.payment.adapt.chinaums;

import com.alibaba.fastjson.JSONObject;
import com.newland.property.boot.properties.WechatAuthProperties;
import com.newland.property.boot.smo.payment.adapt.IPayAdapt;
import com.newland.property.core.factory.ChinaUmsFactory;
...
public class ChinaUmsPayAdapt implements IPayAdapt {
     ...
     */
    @Override
    public Map<String, String> newlandPropertyPayment(RestTemplate outRestTemplate,
                                                      String feeName, String tradeType,
                                                      String orderNum, double money,
                                                      String openId, SmallWeChatDto smallWeChatDto) throws Exception {
        return newlandPropertyPayment(outRestTemplate, feeName, tradeType, orderNum, money, openId, smallWeChatDto, "");
    }
    ...
    public Map<String, String> newlandPropertyPayment(RestTemplate outRestTemplate,
        ...
        if (StringUtil.isEmpty(notifyUrl)) {
            resMap = this.newlandUnifieldOrder(outRestTemplate, feeName, orderNum, tradeType, payAmount, openId, smallWeChatDto);
        } else {
            resMap = this.newlandUnifieldOrder(outRestTemplate, feeName, orderNum, tradeType, payAmount, openId, smallWeChatDto, notifyUrl);
        }
     ...
     * 小程序支付统一下单
     */
    private JSONObject newlandUnifieldOrder(RestTemplate outRestTemplate, String feeName, String orderNum,
                                            String tradeType, double payAmount, String openid,
                                            SmallWeChatDto smallWeChatDto) throws Exception {
        return newlandUnifieldOrder(outRestTemplate, feeName, orderNum, tradeType, payAmount, openid, smallWeChatDto, wechatAuthProperties.getWxNotifyUrl());
    }
