package com.newland.property.boot.smo.assetImport.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.newland.property.boot.smo.DefaultAbstractComponentSMO;
import com.newland.property.boot.smo.assetImport.IImportRoomFeeSMO;
...
import com.newland.property.dto.importData.ImportRoomFee;
    ...
    public ResponseEntity<String> importFile(MultipartFile uploadFile) throws Exception {
        try {
            ...
            if (StringUtil.isEmpty(ossSwitch) || !OSSUtil.OSS_SWITCH_OSS.equals(ossSwitch)) {
                fileName = ftpUploadTemplate.upload(uploadFile, newlandPropertyProperties.getFtpServer(),
                        newlandPropertyProperties.getFtpPort(), newlandPropertyProperties.getFtpUserName(),
                        newlandPropertyProperties.getFtpUserPassword(), "hc/");
            } else {
