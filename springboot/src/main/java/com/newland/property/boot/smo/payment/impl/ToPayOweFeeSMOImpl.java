...
import com.newland.property.boot.smo.payment.IToPayOweFeeSMO;
...
public class ToPayOweFeeSMOImpl extends AppAbstractComponentSMO implements IToPayOweFeeSMO {
    ...
    protected ResponseEntity<String> doBusinessProcess(IPageData pd, JSONObject paramIn) throws Exception {
        ...
        Map result = tPayAdapt.newlandPropertyPayment(outRestTemplate, feeName, paramIn.getString("tradeType"),
