 ...
 */
package com.newland.property.boot.smo.payment.adapt.wechatPay;
...
public class WechatPayAdapt implements IPayAdapt {
     ...
     * 小程序支付统一下单
     */
    private Map<String, String> newlandUnifieldOrder(RestTemplate outRestTemplate, String feeName, String orderNum,
