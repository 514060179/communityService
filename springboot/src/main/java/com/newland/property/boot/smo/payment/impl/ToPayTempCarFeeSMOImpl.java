...
import com.newland.property.boot.smo.payment.IToPayTempCarFeeSMO;
...
import com.newland.property.po.owner.OwnerCarOpenUserPo;
...
public class ToPayTempCarFeeSMOImpl extends AppAbstractComponentSMO implements IToPayTempCarFeeSMO {
    ...
    protected ResponseEntity<String> doBusinessProcess(IPageData pd, JSONObject paramIn) throws Exception {
        ...
        Map result = tPayAdapt.newlandPropertyPayment(outRestTemplate, paramIn.getString("feeName"), paramIn.getString("tradeType"),
