package com.newland.property.boot.filter;

import cn.hutool.jwt.JWTException;
import com.newland.property.core.factory.AuthenticationFactory;
import com.newland.property.core.factory.DataTransactionFactory;
...
import com.newland.property.utils.exception.FilterException;
    ...
    public void doFilter(final ServletRequest req, final ServletResponse res, final FilterChain chain)
        ...
        try {
            ...
            try {
                ...
                Map<String, String> claims = AuthenticationFactory.verifyToken(token, appId);
                ...
                throw new FilterException(ResponseConstant.LOGIN_ON_OTHER_DEVICE_ERROR, e.getMessage());
            }
            catch (Exception e) {
                //Invalid signature/claims
                logger.error("解析token 失败 ：", e);
            ...
            if ("POST".equals(request.getMethod()) || "GET".equals(request.getMethod())) {
                writeJsonData(response,
                        DataTransactionFactory.tokenResponseJson(e.getResult().getCode(), e.getMessage(), null),
                        "UTF-8");
            } else {
...
//StringUtil.isEmpty(token) &&
    ...
    private void writeJsonData(HttpServletResponse response, String data, String encoding) {
        //设置编码格式
