package com.newland.property.boot.smo.payment.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.newland.property.boot.properties.WechatAuthProperties;
import com.newland.property.boot.smo.AppAbstractComponentSMO;
import com.newland.property.boot.smo.payment.IToPaySMO;
        ...
        if (money <= 0) {
            ...
            if (paramIn.containsKey("selectUserAccount") && !StringUtil.isEmpty(paramIn.getString("selectUserAccount"))) {
                ...
                for (int paramIndex = 0; paramIndex < params.size(); paramIndex++) {
                    ...
                    if (!StringUtil.isEmpty(paramObj.getString("acctType")) && "2004".equals(paramObj.getString("acctType"))) { //积分账户
                        //账户金额
...
//                    payFeeDetailPo.setReceivedAmount(subtract.toString());
                    ...
                    } else if (!StringUtil.isEmpty(paramObj.getString("acctType")) && "2003".equals(paramObj.getString("acctType"))) { //现金账户
                        //账户金额
                        BigDecimal amount = new BigDecimal(paramObj.getString("amount"));
                        //获取应收金额
        ...
        Map result = tPayAdapt.newlandPropertyPayment(outRestTemplate, feeName, paramIn.getString("tradeType"), orderId, money, openId, smallWeChatDto);
