...
import com.newland.property.po.coupon.CouponPropertyUserDetailPo;
...
@NewlandPropertyCmdDoc(title = "优惠券赠送车辆",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "carNum", length = 12, remark = "赠送车辆"),
        @NewlandPropertyParamDoc(name = "couponId", length = 30, remark = "赠送优惠券"),
        @NewlandPropertyParamDoc(name = "giftCount", type = "int", length = 11, remark = "赠送数量"),
        @NewlandPropertyParamDoc(name = "paId", length = 30, remark = "停车场"),
...
@NewlandPropertyCmd(serviceCode = "couponProperty.couponPropertyUserGiftCar")
