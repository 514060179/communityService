...
@NewlandPropertyCmdDoc(title = "查询商户停车劵",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "quantity", type = "String", remark = "数量"),
 ...
 */
@NewlandPropertyCmd(serviceCode = "parkingCoupon.listShopParkingCoupon")
