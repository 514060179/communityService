package com.newland.property.acct.payment.business.reserve;
...
import com.newland.property.dto.reserve.ReserveGoodsDto;
...
import com.newland.property.dto.reserve.ReserveParamsDto;
...
import com.newland.property.po.reserve.ReserveGoodsOrderPo;
...
@NewlandPropertyCmdDoc(title = "商品预约",
...
public class ReserveGoodsPaymentBusiness implements IPaymentBusiness {
    ...
    public void notifyPayment(PaymentOrderDto paymentOrderDto, JSONObject reqJson) {
        ...
        // TODO: 预约服务成功发推送-jpush
        // appPage:/pages/reserve/reserveMyOrder

        JPushMessageDto messageDto = new JPushMessageDto();
        messageDto.setCommunityId(reserveGoodsOrderPo.getCommunityId());
        messageDto.setUserId(paymentOrderDto.getUserId());
        messageDto.setPageUrl("/pages/reserve/reserveMyOrder");
        messageDto.setTitle("服务预约");
        messageDto.setContent("您的服务预约成功");
        ...
        userNotificationPo.setCommunityId(reserveGoodsOrderPo.getCommunityId());
        userNotificationPo.setUserId(paymentOrderDto.getUserId());
        userNotificationPo.setNotificationId(0);
        userNotificationPo.setName("服务预约");
        userNotificationPo.setTitle("服务预约");
        userNotificationPo.setContent("您的服务预约成功");
        userNotificationPo.setPageType(0);
        userNotificationPo.setAppPageUrl("/pages/reserve/reserveMyOrder");
