...
@NewlandPropertyCmdDoc(title = "查询停车卷",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "name", type = "String", remark = "优惠券名称"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "typeCdName", type = "String", remark = "类型"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "value", type = "String", remark = "面值"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "valuePrice", type = "String", remark = "售价"),
        }
)
 ...
 */
@NewlandPropertyCmd(serviceCode = "parkingCoupon.listParkingCoupon")
