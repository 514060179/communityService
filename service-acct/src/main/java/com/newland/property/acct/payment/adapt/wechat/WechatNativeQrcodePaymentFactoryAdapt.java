package com.newland.property.acct.payment.adapt.wechat;
...
public class WechatNativeQrcodePaymentFactoryAdapt implements IPaymentFactoryAdapt {
    ...
    public Map newlandPropertyPayment(PaymentOrderDto paymentOrderDto, JSONObject reqJson, ICmdDataFlowContext context) throws Exception {
        ...
        resMap = this.newlandPropertyUnifieldOrder(paymentOrderDto.getName(),
    ...
    private Map<String, String> newlandPropertyUnifieldOrder(String feeName, String orderNum,
