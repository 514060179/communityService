...
import com.newland.property.dto.coupon.CouponPropertyUserDetailDto;
...
@NewlandPropertyCmdDoc(title = "核销优惠券",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "couponQrcode", length = 30, remark = "核销码"),
        @NewlandPropertyParamDoc(name = "giftCount", type = "int", length = 11, remark = "核销数量"),
 ...
 *
 */
@NewlandPropertyCmd(serviceCode = "couponProperty.writeOffCouponPropertyUser")
