package com.newland.property.acct.payment.adapt.bbgpay;
...
import com.newland.property.acct.payment.adapt.bbgpay.lib.GmUtil;
import com.newland.property.acct.payment.adapt.bbgpay.lib.JsonUtil;
...
public class BbgPaymentFactoryAdapt implements IPaymentFactoryAdapt {
    ...
    public Map newlandPropertyPayment(PaymentOrderDto paymentOrderDto, JSONObject reqJson, ICmdDataFlowContext context) throws Exception {
        ...
        resMap = this.newlandUnifieldOrder(paymentOrderDto.getName(),
    ...
    private Map<String, String> newlandUnifieldOrder(String feeName, String orderNum,
