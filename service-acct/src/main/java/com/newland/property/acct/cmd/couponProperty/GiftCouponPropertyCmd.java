...
import com.newland.property.intf.acct.ICouponPropertyPoolDetailV1InnerServiceSMO;
...
import com.newland.property.po.coupon.CouponPropertyPoolDetailPo;
...
@NewlandPropertyCmdDoc(title = "手工赠送优惠券",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "tel", length = 12, remark = "业主手机号"),
        @NewlandPropertyParamDoc(name = "cppId", length = 30, remark = "赠送优惠券"),
        @NewlandPropertyParamDoc(name = "giftCount", type = "int", length = 11, remark = "赠送数量")
})
...
@NewlandPropertyCmd(serviceCode = "couponProperty.giftCouponProperty")
