...
import com.newland.property.dto.itemRelease.ItemReleaseResDto;
...
@NewlandPropertyCmdDoc(title = "查询放行物品",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "irId", length = 30, remark = "物品放行ID"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(name = "data", type = "Array", length = -1, defaultValue = "成功", remark = "数据"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "resName", type = "String", length = -1,  remark = "物品名称"),
        }
)
 ...
 */
@NewlandPropertyCmd(serviceCode = "itemRelease.listItemReleaseRes")
