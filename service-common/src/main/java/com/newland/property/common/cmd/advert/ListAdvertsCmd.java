...
import com.newland.property.vo.api.advert.ApiAdvertDataVo;
import com.newland.property.vo.api.advert.ApiAdvertVo;
...
@NewlandPropertyCmdDoc(title = "查询广告",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "advertId", length = 30, remark = "广告编号 "),
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(name = "adverts", type = "Object", length = 250, defaultValue = "-", remark = "数据"),
                @NewlandPropertyParamDoc(parentNodeName = "adverts",name = "advertId", type = "String", length = 250,  remark = "广告编号"),
                @NewlandPropertyParamDoc(parentNodeName = "adverts",name = "adName", type = "String", length = 250,  remark = "广告名称"),
                @NewlandPropertyParamDoc(parentNodeName = "adverts",name = "startTime", length = 12, remark = "开始时间  "),
                @NewlandPropertyParamDoc(parentNodeName = "adverts",name = "endTime", length = 12, remark = "结束时间 "),
...
@NewlandPropertyCmd(serviceCode = "advert.listAdverts")
