...
@NewlandPropertyCmdDoc(title = "门禁开门记录上传",
...
@NewlandPropertyParamsDoc(params = {
        @NewlandPropertyParamDoc(name = "userId", length = 30, defaultValue = "-1", remark = "用户ID，如果没有填写-1"),
        @NewlandPropertyParamDoc(name = "userName", type = "String", length = 64, remark = "用户 名称"),
        @NewlandPropertyParamDoc(name = "machineCode", type = "String", length = 64, remark = "设备编号"),
        @NewlandPropertyParamDoc(name = "openTypeCd", type = "String", length = 64, remark = "开门类型 1000 人脸"),
        @NewlandPropertyParamDoc(name = "similar", type = "String", length = 64, remark = "相似度 0-1 之间"),
        @NewlandPropertyParamDoc(name = "dateTime", type = "String", length = 64, remark = "开门时间 YYYY-MM-DD hh24:mi:ss"),
        @NewlandPropertyParamDoc(name = "extCommunityId", type = "String", length = 64, remark = "小区ID"),
        @NewlandPropertyParamDoc(name = "recordTypeCd", type = "String", length = 64, remark = "8888 开门记录"),
})
 ...
 * 门禁开门 物联网 触发调用 cmd
 */
@NewlandPropertyCmd(serviceCode = "/machine/openDoorLog")
