package com.newland.property.common.bmo.workflow.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.newland.property.common.bmo.workflow.IQueryWorkFlowFirstStaffBMO;
import com.newland.property.common.dao.IWorkflowServiceDao;
import com.newland.property.common.dao.IWorkflowStepServiceDao;
import com.newland.property.common.dao.IWorkflowStepStaffServiceDao;
...
//        }
    ...
    public ResponseEntity<String> saveModel(WorkflowModelDto workflowModelDto) {
        ...
        try {
            ...
            model.setKey("newland_" + oaWorkflowDtos.get(0).getFlowId());
    ...
    private void dealBpmnXml(WorkflowModelDto workflowModelDto) {
        ...
        newXml = newXml.replaceAll(processIdValue, "newland_" + workflowModelDto.getFlowId());
    ...
    private static String getXml() {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "  <bpmn2:process id=\"newland_752021081769600001\" name=\"请假流程\" isExecutable=\"true\">\n" +
                ...
                "    <bpmndi:BPMNPlane id=\"BPMNPlane_1\" bpmnElement=\"newland_752021081769600001\">\n" +
