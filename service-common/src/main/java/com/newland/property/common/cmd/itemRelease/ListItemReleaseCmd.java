...
@NewlandPropertyCmdDoc(title = "查询物品放行",
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "amount", type = "Array", length = -1,  remark = "数量"),
 ...
 */
@NewlandPropertyCmd(serviceCode = "itemRelease.listItemRelease")
