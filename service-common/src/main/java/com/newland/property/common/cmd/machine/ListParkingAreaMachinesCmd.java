...
@NewlandPropertyCmdDoc(title = "查询停车场设备",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "paId", length = 30, remark = "停车场Id"),
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "machineId", type = "String", remark = "设备ID"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "machineCode", type = "String", remark = "设备编号"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "machineIp", type = "String", remark = "设备IP"),
                @NewlandPropertyParamDoc(parentNodeName = "data",name = "direction", type = "String", remark = "方向"),
        }
)
 ...
 */
@NewlandPropertyCmd(serviceCode = "machine.listParkingAreaMachines")
