...
import com.newland.property.vo.api.machine.ApiMachineDataVo;
import com.newland.property.vo.api.machine.ApiMachineVo;
 ...
 */
@NewlandPropertyCmd(serviceCode = "machine.listMachines")
