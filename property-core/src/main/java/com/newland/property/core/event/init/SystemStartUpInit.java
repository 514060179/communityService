package com.newland.property.core.event.init;

import com.newland.property.core.event.app.AppEvent;
import com.newland.property.core.event.app.AppEventPublishing;
import com.newland.property.core.event.app.AppListener;
import com.newland.property.core.event.listener.common.CommonDispatchListener;
...
public class SystemStartUpInit /*implements ApplicationListener<ApplicationReadyEvent>*/ {
     ...
     * 订单调度处理侦听
     */
    private final static String DISPATCH_LISTER = "newland.event.properties.orderDispatchListener";

    /**
     * 订单调度事件
     */
    private final static String DISPATCH_EVENT = "newland.event.properties.orderDispatchEvent";

    /**
     * 服务
     */
    private final static String LISTENER_SERVICE = "newland.event.properties.listener.service";
