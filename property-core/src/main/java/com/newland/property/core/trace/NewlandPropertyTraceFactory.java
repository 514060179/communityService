...
import com.newland.property.dto.trace.*;
import com.newland.property.utils.constant.CommonConstant;
import com.newland.property.utils.constant.EnvironmentConstant;
...
/**
 * @ClassName PropertyTransactionalFactory
 * @Description TODO
 * @Author wuxw
 * @Date 2020/7/3 22:30
 * @Version 1.0
 ...
 **/
public class NewlandPropertyTraceFactory {

    private static Logger logger = LoggerFactory.getLogger(NewlandPropertyTraceFactory.class);
