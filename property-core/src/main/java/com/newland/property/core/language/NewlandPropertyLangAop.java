...
@Component
@Aspect
public class NewlandPropertyLangAop {



    @Pointcut("@annotation(com.newland.property.core.language.NewlandPropertyLang)")
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String lang = request.getHeader(CommonConstant.PROPERTY_LANG);
        ...
        if (out instanceof ResponseEntity) {
            if(((ResponseEntity) out).getBody() == null){
                return out;
            }
