package com.newland.property.core.event.cmd;

import com.alibaba.fastjson.JSONObject;
import com.newland.property.core.context.ICmdDataFlowContext;
import com.newland.property.core.event.center.DataFlowListenerOrderComparator;
...
public class ServiceCmdEventPublishing {
    ...
    public static void multicastEvent(String serviceCode, final CmdEvent event, String asyn) throws Exception {
        //todo 根据serviceCode 去寻找 处理的Cmd处理类 如果java类中 @NewlandPropertyCmd(serviceCode = "xx.xx") 写了该注解就会被寻找到
