...
public class NewlandPropertyTraceSqlInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        NewlandPropertyTraceFactory.putDbs(boundSql.getSql(), getSqlParam(boundSql, parameterObject, configuration), timing);
