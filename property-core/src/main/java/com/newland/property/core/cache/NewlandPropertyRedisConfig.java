...
@Configuration
@EnableCaching
public class NewlandPropertyRedisConfig extends CachingConfigurerSupport {
...
//    @Autowired
    ...
    public CacheManager cacheManager() {
        ...
        //上面实现的缓存读写
        NewlandPropertyRedisCacheWriter newlandPropertyRedisCacheWriter
                = new NewlandPropertyRedisCacheWriter(connectionFactory);

        CacheManager cm
                = new RedisCacheManager(newlandPropertyRedisCacheWriter, redisCacheConfiguration());
