...
public class SendSmsFactory {
    ...
    private static final String SMS_COMPANY_853 = "SMS_COMPANY_853";
    public static final String SMS_COMPANY_ALI = "ALI";
    public static final String SMS_COMPANY_MENGWANG = "MENGWANG";
    ...
    public static void sendSms(String areaCode, String tel, String code) {

        if ("+853".equals(areaCode)) {
            String smsCompany = MappingCache.getValue(SMS_DOMAIN, SMS_COMPANY_853);

            if (!StringUtils.isEmpty(smsCompany) && SMS_COMPANY_MENGWANG.equals(smsCompany.trim())) {
                MengWangSendMessageFactory.sendMessage(areaCode, tel, code);
            }
            if (!StringUtils.isEmpty(smsCompany) && SMS_COMPANY_ALI.equals(smsCompany.trim())) {
                AliSendMessageFactory.sendMessage(tel, code);
            } else if (SMS_COMPANY_YIDONG.equals(smsCompany.trim())) {
