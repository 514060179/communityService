...
public class Environment {
     ...
     * 判断是否为手机开发模式
     *
     * @param newlandPropertyProperties
     * @return
     */
    public static boolean isOwnerPhone(NewlandPropertyProperties newlandPropertyProperties) {
        //开关是否打开为测试模式
        if (StringUtil.isEmpty(newlandPropertyProperties.getTestSwitch())
                || "0".equals(newlandPropertyProperties.getTestSwitch())) {
            return false;
        }
