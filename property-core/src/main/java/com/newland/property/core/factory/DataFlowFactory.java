...
import com.newland.property.utils.cache.AppRouteCache;
...
import com.newland.property.core.context.AbstractDataFlowContext;
import com.newland.property.core.context.ApiDataFlow;
import com.newland.property.core.context.DataFlow;
import com.newland.property.core.context.OrderDataFlow;
...
public class DataFlowFactory {
    ...
    public static Map getNeedDeleteBusiness(OrderDataFlow dataFlow){
        Map business = new HashMap();
        String bId = "";
        for(com.newland.property.dto.system.Business busi:dataFlow.getBusinessList()){
            bId += busi.getbId()+",";
        }
        business.put("bId",bId.substring(0,bId.length()-1));
        business.put("finishTime",DateUtil.getCurrentDate());
     ...
     * @return
     */
    public static JSONObject getBusinessTableDataInfoToInstanceTableJson(OrderDataFlow dataFlow, com.newland.property.dto.system.Business business){
     ...
     * @return
     */
    public static JSONObject getDeleteInstanceTableJson(OrderDataFlow dataFlow, com.newland.property.dto.system.Business business){
     ...
     * @return
     */
    public static JSONObject getRequestBusinessJson(OrderDataFlow dataFlow, com.newland.property.dto.system.Business business){
     ...
     * @return
     */
    public static List<com.newland.property.dto.system.Business> getSynchronousBusinesses(OrderDataFlow dataFlow){
        AppService service = null;
        AppRoute route = null;
     ...
     * @return
     */
    public static List<com.newland.property.dto.system.Business> getAsynchronousBusinesses(OrderDataFlow dataFlow){
