 ...
 */
public class NewlandPropertyListenerDiscoveryRegistrar implements ImportBeanDefinitionRegistrar,ResourceLoaderAware, BeanClassLoaderAware {

    private ResourceLoader resourceLoader;

    private ClassLoader classLoader;

    public NewlandPropertyListenerDiscoveryRegistrar(){
    ...
    public void registerListener(AnnotationMetadata metadata,
        ...
        Map<String, Object> attrs = metadata
                .getAnnotationAttributes(NewlandPropertyListenerDiscovery.class.getName());

        Object listenerPublishClassObj =  attrs.get("listenerPublishClass");

        Assert.notNull(listenerPublishClassObj,"NewlandPropertyListenerDiscovery 没有配置 listenerPublishClass 属性");

        Class<?> listenerPublishClass = (Class<?>) listenerPublishClassObj;

        AnnotationTypeFilter annotationTypeFilter = new AnnotationTypeFilter(
                NewlandPropertyListener.class);
                ...
                if (candidateComponent instanceof AnnotatedBeanDefinition) {
                    ...
                    Map<String, Object> attributes = annotationMetadata
                            .getAnnotationAttributes(
                                    NewlandPropertyListener.class.getCanonicalName());
                    ...
                    if (beanDefinition.getMetadata().isInterface()
                        ...
                        try {
                            Class<?> target = ClassUtils.forName(
                                    ...
                                    NewlandPropertyListenerDiscoveryRegistrar.this.classLoader);
    ...
    protected Set<String> getBasePackages(AnnotationMetadata importingClassMetadata) {
        Map<String, Object> attributes = importingClassMetadata
                .getAnnotationAttributes(NewlandPropertyListenerDiscovery.class.getCanonicalName());
