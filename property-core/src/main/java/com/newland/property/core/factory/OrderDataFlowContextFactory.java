...
import com.newland.property.core.context.IOrderNotifyDataFlowContext;
import com.newland.property.dto.system.*;
...
public class OrderDataFlowContextFactory {
    ...
    public static List<Map> getBusiness(IOrderDataFlowContext dataFlow) {
        ...
        Map busiMap = null;
        List<com.newland.property.dto.system.Business> businessList = dataFlow.getBusinessList();
        for (com.newland.property.dto.system.Business business : businessList) {
            if (business == null) {
                continue;
            }
    ...
    public static List<Map> getBusinessAttrs(IOrderDataFlowContext dataFlow) {
        ...
        List<com.newland.property.dto.system.Business> businesses = dataFlow.getBusinessList();
        for (com.newland.property.dto.system.Business business : businesses) {
     ...
     * @return
     */
    public static Map getNeedDeleteBusiness(IOrderDataFlowContext dataFlow, List<com.newland.property.dto.system.Business> deleteBusinesses) {
        Map business = new HashMap();
        String bId = "";
        for (com.newland.property.dto.system.Business busi : deleteBusinesses) {
            bId += busi.getbId() + ",";
        }
     ...
     * @return
     */
    public static JSONObject getBusinessTableDataInfoToInstanceTableJson(IOrderDataFlowContext dataFlow, com.newland.property.dto.system.Business business) {
     ...
     * @return
     */
    public static JSONObject getDeleteInstanceTableJson(IOrderDataFlowContext dataFlow, com.newland.property.dto.system.Business business) {
     ...
     * @return
     */
    public static JSONObject getRequestBusinessJson(IOrderDataFlowContext dataFlow, com.newland.property.dto.system.Business business) {
     ...
     * @return
     */
    public static List<com.newland.property.dto.system.Business> getSynchronousBusinesses(IOrderDataFlowContext dataFlow) {
        List<com.newland.property.dto.system.Business> syschronousBusinesses = new ArrayList<com.newland.property.dto.system.Business>();
        for (com.newland.property.dto.system.Business business : dataFlow.getBusinessList()) {
     ...
     * @return
     */
    public static List<com.newland.property.dto.system.Business> getAsynchronousBusinesses(IOrderDataFlowContext dataFlow) {

        List<com.newland.property.dto.system.Business> asynchronousBusinesses = new ArrayList<com.newland.property.dto.system.Business>();
        for (com.newland.property.dto.system.Business business : dataFlow.getBusinessList()) {
