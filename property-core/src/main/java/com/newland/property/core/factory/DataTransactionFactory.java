...
import com.newland.property.utils.constant.OrderTypeCdConstant;
...
public class DataTransactionFactory {
    ...
    public static String tokenResponseJson(String code,String message,JSONObject data) {
        JSONObject paramOut = JSONObject.parseObject("{}");
        paramOut.put("code", Integer.parseInt(code));
        paramOut.put("msg", message);
        paramOut.put("responseTime", DateUtil.getNowDefault());
        if (data != null) {
            paramOut.put("data", data);
        }
