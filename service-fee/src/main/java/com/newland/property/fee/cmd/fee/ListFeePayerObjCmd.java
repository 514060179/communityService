...
@NewlandPropertyCmdDoc(title = "查询费用作用对象",
...
@NewlandPropertyParamsDoc(params = {
        ...
        @NewlandPropertyParamDoc(name = "payerObjId", length = 30, remark = "对象ID"),
        @NewlandPropertyParamDoc(name = "payerObjType", length = 12, remark = "对象类型"),
})
...
@NewlandPropertyResponseDoc(
        params = {
                ...
                @NewlandPropertyParamDoc(name = "data", type = "Object", length = -1, defaultValue = "成功", remark = "数据"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "payerObjId", length = 30, remark = "费用对象ID"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "payerObjName", length = 64, remark = "费用对象名称"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "paNum", length = 11, remark = "停车场"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "psNum", length = 30, remark = "车位"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "ownerId", length = 30, remark = "业主Id"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "ownerName", length = 64, remark = "业主名称"),
                @NewlandPropertyParamDoc(parentNodeName = "data", name = "tel", length = 11, remark = "手机号"),
        }
)
...
@NewlandPropertyCmd(serviceCode = "fee.listFeePayerObj")
