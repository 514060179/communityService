...
import com.newland.property.dto.fee.ComputeDiscountDto;
...
import com.newland.property.fee.bmo.fee.IFeeBMO;
import com.newland.property.intf.acct.IAccountInnerServiceSMO;
import com.newland.property.intf.acct.ICouponUserDetailV1InnerServiceSMO;
...
import com.newland.property.po.coupon.CouponUserPo;
import com.newland.property.po.coupon.CouponUserDetailPo;
...
@NewlandPropertyCmd(serviceCode = "fee.payFeeConfirm")
public class PayFeeConfirmCmd extends Cmd {
    ...
    private void dealAccount(JSONObject paramObj) {
        ...
        for (int accountIndex = 0; accountIndex < accountDtos.size(); accountIndex++) {
            ...
            if (!StringUtil.isEmpty(accountDto.getAcctType()) && "2003".equals(accountDto.getAcctType())) { //2003 现金账户 2004 积分账户
                //获取现金账户抵扣金额
            ...
            } else if (!StringUtil.isEmpty(accountDto.getAcctType()) && "2004".equals(accountDto.getAcctType())) { //积分账户
                //获取积分账户抵扣的积分数
